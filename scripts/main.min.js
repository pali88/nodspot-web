...
X(d)&&b.$parsers.push(function(c){return b.$error[a]||!(d.badInput||d.customError||d.typeMismatch)||d.valueMissing?c:void b.$setValidity(a,!1)})}function ub(b,a,c,d,e,g){var f=a.prop("validity");if(!e.android){var h=!1;a.on("compositionstart",function(){h=!0}),a.on("compositionend",function(){h=!1,l()})}var l=function(){if(!h){var e=a.val();Qa(c.ngTrim||"T")&&(e=ca(e)),(d.$viewValue!==e||f&&""===e&&!f.valueMissing)&&(b.$$phase?d.$setViewValue(e):b.$apply(function(){d.$setViewValue(e)}))}};if(e.hasEvent("input"))a.on("input",l);else{var k,m=function(){k||(k=g.defer(function(){l(),k=null}))};a.on("keydown",function(a){a=a.keyCode,91===a||a>15&&19>a||a>=37&&40>=a||m()}),e.hasEvent("paste")&&a.on("paste cut",m)}a.on("change",l),d.$render=function(){a.val(d.$isEmpty(d.$viewValue)?"":d.$viewValue)};var n=c.ngPattern;if(n&&((e=n.match(/^\/(.*)\/([gim]*)$/))?(n=RegExp(e[1],e[2]),e=function(a){return pa(d,"pattern",d.$isEmpty(a)||n.test(a),a)}):e=function(c){var e=b.$eval(n);if(!e||!e.test)throw t("ngPattern")("noregexp",n,e,ha(a));return pa(d,"pattern",d.$isEmpty(c)||e.test(c),c)},d.$formatters.push(e),d.$parsers.push(e)),c.ngMinlength){var p=Y(c.ngMinlength);e=function(a){return pa(d,"minlength",d.$isEmpty(a)||a.length>=p,a)},d.$parsers.push(e),d.$formatters.push(e)}if(c.ngMaxlength){var r=Y(c.ngMaxlength);e=function(a){return pa(d,"maxlength",d.$isEmpty(a)||a.length<=r,a)},d.$parsers.push(e),d.$formatters.push(e)}}function Pb(b,a){return b="ngClass"+b,["$animate",function(c){function d(a,b){var c=[],d=0;a:for(;d<a.length;d++){for(var e=a[d],m=0;m<b.length;m++)if(e==b[m])continue a;c.push(e)}return c}function e(a){if(!M(a)){if(w(a))return a.split(" ");if(X(a)){var b=[];return q(a,function(a,c){a&&b.push(c)}),b}}return a}return{restrict:"AC",link:function(g,f,h){function l(a,b){var c=f.data("$classCounts")||{},d=[];return q(a,function(a){(b>0||c[a])&&(c[a]=(c[a]||0)+b,c[a]===+(b>0)&&d.push(a))}),f.data("$classCounts",c),d.join(" ")}function k(b){if(!0===a||g.$index%2===a){var k=e(b||[]);if(m){if(!xa(b,m)){var q=e(m),r=d(k,q),k=d(q,k),k=l(k,-1),r=l(r,1);0===r.length?c.removeClass(f,k):0===k.length?c.addClass(f,r):c.setClass(f,r,k)}}else{var r=l(k,1);h.$addClass(r)}}m=ba(b)}var m;g.$watch(h[b],k,!0),h.$observe("class",function(){k(g.$eval(h[b]))}),"ngClass"!==b&&g.$watch("$index",function(c,d){var f=1&c;if(f!==d&1){var k=e(g.$eval(h[b]));f===a?(f=l(k,1),h.$addClass(f)):(f=l(k,-1),h.$removeClass(f))}})}}}]}var S,y,Ga,Sa,Ka,K=function(b){return w(b)?b.toLowerCase():b},Fc=Object.prototype.hasOwnProperty,Fa=function(b){return w(b)?b.toUpperCase():b},ya=[].slice,Ke=[].push,wa=Object.prototype.toString,Pa=t("ng"),Ea=O.angular||(O.angular={}),ka=["0","0","0"];S=Y((/msie (\d+)/.exec(K(navigator.userAgent))||[])[1]),isNaN(S)&&(S=Y((/trident\/.*; rv:(\d+)/.exec(K(navigator.userAgent))||[])[1])),C.$inject=[],Da.$inject=[];var ca=function(){return String.prototype.trim?function(b){return w(b)?b.trim():b}:function(b){return w(b)?b.replace(/^\s\s*/,"").replace(/\s\s*$/,""):b}}();Ka=9>S?function(b){return b=b.nodeName?b:b[0],b.scopeName&&"HTML"!=b.scopeName?Fa(b.scopeName+":"+b.nodeName):b.nodeName}:function(b){return b.nodeName?b.nodeName:b[0].nodeName};var Xc=/[A-Z]/g,$c={full:"1.2.16",major:1,minor:2,dot:16,codeName:"badger-enumeration"},Ua=N.cache={},gb=N.expando="ng-"+(new Date).getTime(),me=1,Pc=O.document.addEventListener?function(b,a,c){b.addEventListener(a,c,!1)}:function(b,a,c){b.attachEvent("on"+a,c)},Fb=O.document.removeEventListener?function(b,a,c){b.removeEventListener(a,c,!1)}:function(b,a,c){b.detachEvent("on"+a,c)};N._data=function(b){return this.cache[b[this.expando]]||{}};var he=/([\:\-\_]+(.))/g,ie=/^moz([A-Z])/,Bb=t("jqLite"),je=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Cb=/<|&#?\w+;/,ke=/<([\w:]+)/,le=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,ea={option:[1,'<select multiple="multiple">',"</select>"],thead:[1,"<table>","</table>"],col:[2,"<table><colgroup>","</colgroup></table>"],tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:[0,"",""]};ea.optgroup=ea.option,ea.tbody=ea.tfoot=ea.colgroup=ea.caption=ea.thead,ea.th=ea.td;var Ja=N.prototype={ready:function(b){function a(){c||(c=!0,b())}var c=!1;"complete"===U.readyState?setTimeout(a):(this.on("DOMContentLoaded",a),N(O).on("load",a))},toString:function(){var b=[];return q(this,function(a){b.push(""+a)}),"["+b.join(", ")+"]"},eq:function(b){return y(b>=0?this[b]:this[this.length+b])},length:0,push:Ke,sort:[].sort,splice:[].splice},kb={};q("multiple selected checked disabled readOnly required open".split(" "),function(b){kb[K(b)]=b});var nc={};q("input select option textarea button form details".split(" "),function(b){nc[Fa(b)]=!0}),q({data:jc,inheritedData:jb,scope:function(b){return y(b).data("$scope")||jb(b.parentNode||b,["$isolateScope","$scope"])},isolateScope:function(b){return y(b).data("$isolateScope")||y(b).data("$isolateScopeNoTemplate")},controller:kc,injector:function(b){return jb(b,"$injector")},removeAttr:function(b,a){b.removeAttribute(a)},hasClass:Gb,css:function(b,a,c){if(a=Ta(a),!B(c)){var d;return 8>=S&&(d=b.currentStyle&&b.currentStyle[a],""===d&&(d="auto")),d=d||b.style[a],8>=S&&(d=""===d?s:d),d}b.style[a]=c},attr:function(b,a,c){var d=K(a);if(kb[d]){if(!B(c))return b[a]||(b.attributes.getNamedItem(a)||C).specified?d:s;c?(b[a]=!0,b.setAttribute(a,d)):(b[a]=!1,b.removeAttribute(d))}else if(B(c))b.setAttribute(a,c);else if(b.getAttribute)return b=b.getAttribute(a,2),null===b?s:b},prop:function(b,a,c){return B(c)?void(b[a]=c):b[a]},text:function(){function b(b,d){var e=a[b.nodeType];return E(d)?e?b[e]:"":void(b[e]=d)}var a=[];return 9>S?(a[1]="innerText",a[3]="nodeValue"):a[1]=a[3]="textContent",b.$dv="",b}(),val:function(b,a){if(E(a)){if("SELECT"===Ka(b)&&b.multiple){var c=[];return q(b.options,function(a){a.selected&&c.push(a.value||a.text)}),0===c.length?null:c}return b.value}b.value=a},html:function(b,a){if(E(a))return b.innerHTML;for(var c=0,d=b.childNodes;c<d.length;c++)Ha(d[c]);b.innerHTML=a},empty:lc},function(b,a){N.prototype[a]=function(a,d){var e,g;if(b!==lc&&(2==b.length&&b!==Gb&&b!==kc?a:d)===s){if(X(a)){for(e=0;e<this.length;e++)if(b===jc)b(this[e],a);else for(g in a)b(this[e],g,a[g]);return this}e=b.$dv,g=e===s?Math.min(this.length,1):this.length;for(var f=0;g>f;f++){var h=b(this[f],a,d);e=e?e+h:h}return e}for(e=0;e<this.length;e++)b(this[e],a,d);return this}}),q({removeData:hc,dealoc:Ha,on:function a(c,d,e,g){if(B(g))throw Bb("onargs");var f=la(c,"events"),h=la(c,"handle");f||la(c,"events",f={}),h||la(c,"handle",h=ne(c,f)),q(d.split(" "),function(d){var g=f[d];if(!g){if("mouseenter"==d||"mouseleave"==d){var m=U.body.contains||U.body.compareDocumentPosition?function(a,c){var d=9===a.nodeType?a.documentElement:a,e=c&&c.parentNode;return a===e||!(!e||1!==e.nodeType||!(d.contains?d.contains(e):a.compareDocumentPosition&&16&a.compareDocumentPosition(e)))}:function(a,c){if(c)for(;c=c.parentNode;)if(c===a)return!0;return!1};f[d]=[],a(c,{mouseleave:"mouseout",mouseenter:"mouseover"}[d],function(a){var c=a.relatedTarget;c&&(c===this||m(this,c))||h(a,d)})}else Pc(c,d,h),f[d]=[];g=f[d]}g.push(e)})},off:ic,one:function(a,c,d){a=y(a),a.on(c,function g(){a.off(c,d),a.off(c,g)}),a.on(c,d)},replaceWith:function(a,c){var d,e=a.parentNode;Ha(a),q(new N(c),function(c){d?e.insertBefore(c,d.nextSibling):e.replaceChild(c,a),d=c})},children:function(a){var c=[];return q(a.childNodes,function(a){1===a.nodeType&&c.push(a)}),c},contents:function(a){return a.contentDocument||a.childNodes||[]},append:function(a,c){q(new N(c),function(c){1!==a.nodeType&&11!==a.nodeType||a.appendChild(c)})},prepend:function(a,c){if(1===a.nodeType){var d=a.firstChild;q(new N(c),function(c){a.insertBefore(c,d)})}},wrap:function(a,c){c=y(c)[0];var d=a.parentNode;d&&d.replaceChild(c,a),c.appendChild(a)},remove:function(a){Ha(a);var c=a.parentNode;c&&c.removeChild(a)},after:function(a,c){var d=a,e=a.parentNode;q(new N(c),function(a){e.insertBefore(a,d.nextSibling),d=a})},addClass:ib,removeClass:hb,toggleClass:function(a,c,d){c&&q(c.split(" "),function(c){var g=d;E(g)&&(g=!Gb(a,c)),(g?ib:hb)(a,c)})},parent:function(a){return(a=a.parentNode)&&11!==a.nodeType?a:null},next:function(a){if(a.nextElementSibling)return a.nextElementSibling;for(a=a.nextSibling;null!=a&&1!==a.nodeType;)a=a.nextSibling;return a},find:function(a,c){return a.getElementsByTagName?a.getElementsByTagName(c):[]},clone:Eb,triggerHandler:function(a,c,d){c=(la(a,"events")||{})[c],d=d||[];var e=[{preventDefault:C,stopPropagation:C}];q(c,function(c){c.apply(a,e.concat(d))})}},function(a,c){N.prototype[c]=function(c,e,g){for(var f,h=0;h<this.length;h++)E(f)?(f=a(this[h],c,e,g),B(f)&&(f=y(f))):Db(f,a(this[h],c,e,g));return B(f)?f:this},N.prototype.bind=N.prototype.on,N.prototype.unbind=N.prototype.off}),Va.prototype={put:function(a,c){this[Ia(a)]=c},get:function(a){return this[Ia(a)]},remove:function(a){var c=this[a=Ia(a)];return delete this[a],c}};var pe=/^function\s*[^\(]*\(\s*([^\)]*)\)/m,qe=/,/,re=/^\s*(_?)(\S+?)\1\s*$/,oe=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm,Wa=t("$injector"),Le=t("$animate"),Ld=["$provide",function(a){this.$$selectors={},this.register=function(c,d){var e=c+"-animation";if(c&&"."!=c.charAt(0))throw Le("notcsel",c);this.$$selectors[c.substr(1)]=e,a.factory(e,d)},this.classNameFilter=function(a){return 1===arguments.length&&(this.$$classNameFilter=a instanceof RegExp?a:null),this.$$classNameFilter},this.$get=["$timeout","$$asyncCallback",function(a,d){return{enter:function(a,c,f,h){f?f.after(a):(c&&c[0]||(c=f.parent()),c.append(a)),h&&d(h)},leave:function(a,c){a.remove(),c&&d(c)},move:function(a,c,d,h){this.enter(a,c,d,h)},addClass:function(a,c,f){c=w(c)?c:M(c)?c.join(" "):"",q(a,function(a){ib(a,c)}),f&&d(f)},removeClass:function(a,c,f){c=w(c)?c:M(c)?c.join(" "):"",q(a,function(a){hb(a,c)}),f&&d(f)},setClass:function(a,c,f,h){q(a,function(a){ib(a,c),hb(a,f)}),h&&d(h)},enabled:C}}]}],ja=t("$compile");cc.$inject=["$provide","$$sanitizeUriProvider"];var te=/^(x[\:\-_]|data[\:\-_])/i,vc=t("$interpolate"),Me=/^([^\?#]*)(\?([^#]*))?(#(.*))?$/,we={http:80,https:443,ftp:21},Kb=t("$location");Ac.prototype=Lb.prototype=zc.prototype={$$html5:!1,$$replace:!1,absUrl:nb("$$absUrl"),url:function(a,c){if(E(a))return this.$$url;var d=Me.exec(a);return d[1]&&this.path(decodeURIComponent(d[1])),(d[2]||d[1])&&this.search(d[3]||""),this.hash(d[5]||"",c),this},protocol:nb("$$protocol"),host:nb("$$host"),port:nb("$$port"),path:Bc("$$path",function(a){return"/"==a.charAt(0)?a:"/"+a}),search:function(a,c){switch(arguments.length){case 0:return this.$$search;case 1:if(w(a))this.$$search=Yb(a);else{if(!X(a))throw Kb("isrcharg");this.$$search=a}break;default:E(c)||null===c?delete this.$$search[a]:this.$$search[a]=c}return this.$$compose(),this},hash:Bc("$$hash",Da),replace:function(){return this.$$replace=!0,this}};var ta,Ba=t("$parse"),Ec={},Ma={"null":function(){return null},"true":function(){return!0},"false":function(){return!1},undefined:C,"+":function(a,c,d,e){return d=d(a,c),e=e(a,c),B(d)?B(e)?d+e:d:B(e)?e:s},"-":function(a,c,d,e){return d=d(a,c),e=e(a,c),(B(d)?d:0)-(B(e)?e:0)},"*":function(a,c,d,e){return d(a,c)*e(a,c)},"/":function(a,c,d,e){return d(a,c)/e(a,c)},"%":function(a,c,d,e){return d(a,c)%e(a,c)},"^":function(a,c,d,e){return d(a,c)^e(a,c)},"=":C,"===":function(a,c,d,e){return d(a,c)===e(a,c)},"!==":function(a,c,d,e){return d(a,c)!==e(a,c)},"==":function(a,c,d,e){return d(a,c)==e(a,c)},"!=":function(a,c,d,e){return d(a,c)!=e(a,c)},"<":function(a,c,d,e){return d(a,c)<e(a,c)},">":function(a,c,d,e){return d(a,c)>e(a,c)},"<=":function(a,c,d,e){return d(a,c)<=e(a,c)},">=":function(a,c,d,e){return d(a,c)>=e(a,c)},"&&":function(a,c,d,e){return d(a,c)&&e(a,c)},"||":function(a,c,d,e){return d(a,c)||e(a,c)},"&":function(a,c,d,e){return d(a,c)&e(a,c)},"|":function(a,c,d,e){return e(a,c)(a,c,d(a,c))},"!":function(a,c,d){return!d(a,c)}},Ne={n:"\n",f:"\f",r:"\r",t:"	",v:"","'":"'",'"':'"'},Nb=function(a){this.options=a};Nb.prototype={constructor:Nb,lex:function(a){this.text=a,this.index=0,this.ch=s,this.lastCh=":",this.tokens=[];var c;for(a=[];this.index<this.text.length;){if(this.ch=this.text.charAt(this.index),this.is("\"'"))this.readString(this.ch);else if(this.isNumber(this.ch)||this.is(".")&&this.isNumber(this.peek()))this.readNumber();else if(this.isIdent(this.ch))this.readIdent(),this.was("{,")&&"{"===a[0]&&(c=this.tokens[this.tokens.length-1])&&(c.json=-1===c.text.indexOf("."));else if(this.is("(){}[].,;:?"))this.tokens.push({index:this.index,text:this.ch,json:this.was(":[,")&&this.is("{[")||this.is("}]:,")}),this.is("{[")&&a.unshift(this.ch),this.is("}]")&&a.shift(),this.index++;else{if(this.isWhitespace(this.ch)){this.index++;continue}var d=this.ch+this.peek(),e=d+this.peek(2),g=Ma[this.ch],f=Ma[d],h=Ma[e];h?(this.tokens.push({index:this.index,text:e,fn:h}),this.index+=3):f?(this.tokens.push({index:this.index,text:d,fn:f}),this.index+=2):g?(this.tokens.push({index:this.index,text:this.ch,fn:g,json:this.was("[,:")&&this.is("+-")}),this.index+=1):this.throwError("Unexpected next character ",this.index,this.index+1)}this.lastCh=this.ch}return this.tokens},is:function(a){return-1!==a.indexOf(this.ch)},was:function(a){return-1!==a.indexOf(this.lastCh)},peek:function(a){return a=a||1,this.index+a<this.text.length?this.text.charAt(this.index+a):!1},isNumber:function(a){return a>="0"&&"9">=a},isWhitespace:function(a){return" "===a||"\r"===a||"	"===a||"\n"===a||""===a||" "===a},isIdent:function(a){return a>="a"&&"z">=a||a>="A"&&"Z">=a||"_"===a||"$"===a},isExpOperator:function(a){return"-"===a||"+"===a||this.isNumber(a)},throwError:function(a,c,d){throw d=d||this.index,c=B(c)?"s "+c+"-"+this.index+" ["+this.text.substring(c,d)+"]":" "+d,Ba("lexerr",a,c,this.text)},readNumber:function(){for(var a="",c=this.index;this.index<this.text.length;){var d=K(this.text.charAt(this.index));if("."==d||this.isNumber(d))a+=d;else{var e=this.peek();if("e"==d&&this.isExpOperator(e))a+=d;else if(this.isExpOperator(d)&&e&&this.isNumber(e)&&"e"==a.charAt(a.length-1))a+=d;else{if(!this.isExpOperator(d)||e&&this.isNumber(e)||"e"!=a.charAt(a.length-1))break;this.throwError("Invalid exponent")}}this.index++}a*=1,this.tokens.push({index:c,text:a,json:!0,fn:function(){return a}})},readIdent:function(){for(var e,g,f,h,a=this,c="",d=this.index;this.index<this.text.length&&(h=this.text.charAt(this.index),"."===h||this.isIdent(h)||this.isNumber(h));)"."===h&&(e=this.index),c+=h,this.index++;if(e)for(g=this.index;g<this.text.length;){if(h=this.text.charAt(g),"("===h){f=c.substr(e-d+1),c=c.substr(0,e-d),this.index=g;break}if(!this.isWhitespace(h))break;g++}if(d={index:d,text:c},Ma.hasOwnProperty(c))d.fn=Ma[c],d.json=Ma[c];else{var l=Dc(c,this.options,this.text);d.fn=D(function(a,c){return l(a,c)},{assign:function(d,e){return ob(d,c,e,a.text,a.options)}})}this.tokens.push(d),f&&(this.tokens.push({index:e,text:".",json:!1}),this.tokens.push({index:e+1,text:f,json:!1}))},readString:function(a){var c=this.index;this.index++;for(var d="",e=a,g=!1;this.index<this.text.length;){var f=this.text.charAt(this.index),e=e+f;if(g)"u"===f?(f=this.text.substring(this.index+1,this.index+5),f.match(/[\da-f]{4}/i)||this.throwError("Invalid unicode escape [\\u"+f+"]"),this.index+=4,d+=String.fromCharCode(parseInt(f,16))):d=(g=Ne[f])?d+g:d+f,g=!1;else if("\\"===f)g=!0;else{if(f===a)return this.index++,void this.tokens.push({index:c,text:e,string:d,json:!0,fn:function(){return d}});d+=f}this.index++}this.throwError("Unterminated quote",c)}};var $a=function(a,c,d){this.lexer=a,this.$filter=c,this.options=d};$a.ZERO=D(function(){return 0},{constant:!0}),$a.prototype={constructor:$a,parse:function(a,c){this.text=a,this.json=c,this.tokens=this.lexer.lex(a),c&&(this.assignment=this.logicalOR,this.functionCall=this.fieldAccess=this.objectIndex=this.filterChain=function(){this.throwError("is not valid json",{text:a,index:0})});var d=c?this.primary():this.statements();return 0!==this.tokens.length&&this.throwError("is an unexpected token",this.tokens[0]),d.literal=!!d.literal,d.constant=!!d.constant,d},primary:function(){var a;if(this.expect("("))a=this.filterChain(),this.consume(")");else if(this.expect("["))a=this.arrayDeclaration();else if(this.expect("{"))a=this.object();else{var c=this.expect();(a=c.fn)||this.throwError("not a primary expression",c),c.json&&(a.constant=!0,a.literal=!0)}for(var d;c=this.expect("(","[",".");)"("===c.text?(a=this.functionCall(a,d),d=null):"["===c.text?(d=a,a=this.objectIndex(a)):"."===c.text?(d=a,a=this.fieldAccess(a)):this.throwError("IMPOSSIBLE");return a},throwError:function(a,c){throw Ba("syntax",c.text,a,c.index+1,this.text,this.text.substring(c.index))},peekToken:function(){if(0===this.tokens.length)throw Ba("ueoe",this.text);return this.tokens[0]},peek:function(a,c,d,e){if(0<this.tokens.length){var g=this.tokens[0],f=g.text;if(f===a||f===c||f===d||f===e||!(a||c||d||e))return g}return!1},expect:function(a,c,d,e){return(a=this.peek(a,c,d,e))?(this.json&&!a.json&&this.throwError("is not valid json",a),this.tokens.shift(),a):!1},consume:function(a){this.expect(a)||this.throwError("is unexpected, expecting ["+a+"]",this.peek())},unaryFn:function(a,c){return D(function(d,e){return a(d,e,c)},{constant:c.constant})},ternaryFn:function(a,c,d){return D(function(e,g){return a(e,g)?c(e,g):d(e,g)},{constant:a.constant&&c.constant&&d.constant})},binaryFn:function(a,c,d){return D(function(e,g){return c(e,g,a,d)},{constant:a.constant&&d.constant})},statements:function(){for(var a=[];;)if(0<this.tokens.length&&!this.peek("}",")",";","]")&&a.push(this.filterChain()),!this.expect(";"))return 1===a.length?a[0]:function(c,d){for(var e,g=0;g<a.length;g++){var f=a[g];f&&(e=f(c,d))}return e}},filterChain:function(){for(var c,a=this.expression();;){if(!(c=this.expect("|")))return a;a=this.binaryFn(a,c.fn,this.filter())}},filter:function(){for(var a=this.expect(),c=this.$filter(a.text),d=[];;){if(!(a=this.expect(":"))){var e=function(a,e,h){h=[h];for(var l=0;l<d.length;l++)h.push(d[l](a,e));return c.apply(a,h)};return function(){return e}}d.push(this.expression())}},expression:function(){return this.assignment()},assignment:function(){var c,d,a=this.ternary();return(d=this.expect("="))?(a.assign||this.throwError("implies assignment but ["+this.text.substring(0,d.index)+"] can not be assigned to",d),c=this.ternary(),function(d,g){return a.assign(d,c(d,g),g)}):a},ternary:function(){var c,d,a=this.logicalOR();return this.expect("?")?(c=this.ternary(),(d=this.expect(":"))?this.ternaryFn(a,c,this.ternary()):void this.throwError("expected :",d)):a},logicalOR:function(){for(var c,a=this.logicalAND();;){if(!(c=this.expect("||")))return a;a=this.binaryFn(a,c.fn,this.logicalAND())}},logicalAND:function(){var c,a=this.equality();return(c=this.expect("&&"))&&(a=this.binaryFn(a,c.fn,this.logicalAND())),a},equality:function(){var c,a=this.relational();return(c=this.expect("==","!=","===","!=="))&&(a=this.binaryFn(a,c.fn,this.equality())),a},relational:function(){var c,a=this.additive();return(c=this.expect("<",">","<=",">="))&&(a=this.binaryFn(a,c.fn,this.relational())),a},additive:function(){for(var c,a=this.multiplicative();c=this.expect("+","-");)a=this.binaryFn(a,c.fn,this.multiplicative());return a},multiplicative:function(){for(var c,a=this.unary();c=this.expect("*","/","%");)a=this.binaryFn(a,c.fn,this.unary());return a},unary:function(){var a;return this.expect("+")?this.primary():(a=this.expect("-"))?this.binaryFn($a.ZERO,a.fn,this.unary()):(a=this.expect("!"))?this.unaryFn(a.fn,this.unary()):this.primary()},fieldAccess:function(a){var c=this,d=this.expect().text,e=Dc(d,this.options,this.text);return D(function(c,d,h){return e(h||a(c,d))},{assign:function(e,f,h){return ob(a(e,h),d,f,c.text,c.options)}})},objectIndex:function(a){var c=this,d=this.expression();return this.consume("]"),D(function(e,g){var l,f=a(e,g),h=d(e,g);return f?((f=Za(f[h],c.text))&&f.then&&c.options.unwrapPromises&&(l=f,"$$v"in f||(l.$$v=s,l.then(function(a){l.$$v=a})),f=f.$$v),f):s},{assign:function(e,g,f){var h=d(e,f);return Za(a(e,f),c.text)[h]=g}})},functionCall:function(a,c){var d=[];if(")"!==this.peekToken().text)do d.push(this.expression());while(this.expect(","));this.consume(")");var e=this;return function(g,f){for(var h=[],l=c?c(g,f):g,k=0;k<d.length;k++)h.push(d[k](g,f));return k=a(g,f,l)||C,Za(l,e.text),Za(k,e.text),h=k.apply?k.apply(l,h):k(h[0],h[1],h[2],h[3],h[4]),Za(h,e.text)}},arrayDeclaration:function(){var a=[],c=!0;if("]"!==this.peekToken().text)do{if(this.peek("]"))break;var d=this.expression();a.push(d),d.constant||(c=!1)}while(this.expect(","));return this.consume("]"),D(function(c,d){for(var f=[],h=0;h<a.length;h++)f.push(a[h](c,d));return f},{literal:!0,constant:c})},object:function(){var a=[],c=!0;if("}"!==this.peekToken().text)do{if(this.peek("}"))break;var d=this.expect(),d=d.string||d.text;this.consume(":");var e=this.expression();a.push({key:d,value:e}),e.constant||(c=!1)}while(this.expect(","));return this.consume("}"),D(function(c,d){for(var e={},l=0;l<a.length;l++){var k=a[l];e[k.key]=k.value(c,d)}return e},{literal:!0,constant:c})}};var Mb={},ua=t("$sce"),ga={HTML:"html",CSS:"css",URL:"url",RESOURCE_URL:"resourceUrl",JS:"js"},W=U.createElement("a"),Hc=sa(O.location.href,!0);gc.$inject=["$provide"],Ic.$inject=["$locale"],Kc.$inject=["$locale"];var Nc=".",Ie={yyyy:$("FullYear",4),yy:$("FullYear",2,0,!0),y:$("FullYear",1),MMMM:pb("Month"),MMM:pb("Month",!0),MM:$("Month",2,1),M:$("Month",1,1),dd:$("Date",2),d:$("Date",1),HH:$("Hours",2),H:$("Hours",1),hh:$("Hours",2,-12),h:$("Hours",1,-12),mm:$("Minutes",2),m:$("Minutes",1),ss:$("Seconds",2),s:$("Seconds",1),sss:$("Milliseconds",3),EEEE:pb("Day"),EEE:pb("Day",!0),a:function(a,c){return 12>a.getHours()?c.AMPMS[0]:c.AMPMS[1]},Z:function(a){return a=-1*a.getTimezoneOffset(),a=(a>=0?"+":"")+(Ob(Math[a>0?"floor":"ceil"](a/60),2)+Ob(Math.abs(a%60),2))}},He=/((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/,Ge=/^\-?\d+$/;Jc.$inject=["$locale"];var Ee=aa(K),Fe=aa(Fa);Lc.$inject=["$parse"];var cd=aa({restrict:"E",compile:function(a,c){return 8>=S&&(c.href||c.name||c.$set("href",""),a.append(U.createComment("IE fix"))),c.href||c.xlinkHref||c.name?void 0:function(a,c){var g="[object SVGAnimatedString]"===wa.call(c.prop("href"))?"xlink:href":"href";c.on("click",function(a){c.attr(g)||a.preventDefault()})}}}),zb={};q(kb,function(a,c){if("multiple"!=a){var d=na("ng-"+c);zb[d]=function(){return{priority:100,link:function(a,g,f){a.$watch(f[d],function(a){f.$set(c,!!a)})}}}}}),q(["src","srcset","href"],function(a){var c=na("ng-"+a);zb[c]=function(){return{priority:99,link:function(d,e,g){var f=a,h=a;"href"===a&&"[object SVGAnimatedString]"===wa.call(e.prop("href"))&&(h="xlinkHref",g.$attr[h]="xlink:href",f=null),g.$observe(c,function(a){a&&(g.$set(h,a),S&&f&&e.prop(f,g[h]))})}}}});var sb={$addControl:C,$removeControl:C,$setValidity:C,$setDirty:C,$setPristine:C};Oc.$inject=["$element","$attrs","$scope","$animate"];var Qc=function(a){return["$timeout",function(c){return{name:"form",restrict:a?"EAC":"E",controller:Oc,compile:function(){return{pre:function(a,e,g,f){if(!g.action){var h=function(a){a.preventDefault?a.preventDefault():a.returnValue=!1};Pc(e[0],"submit",h),e.on("$destroy",function(){c(function(){Fb(e[0],"submit",h)},0,!1)})}var l=e.parent().controller("form"),k=g.name||g.ngForm;k&&ob(a,k,f,k),l&&e.on("$destroy",function(){l.$removeControl(f),k&&ob(a,k,s,k),D(f,sb)})}}}}}]},dd=Qc(),qd=Qc(!0),Oe=/^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,Pe=/^[a-z0-9!#$%&'*+/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i,Qe=/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,Rc={text:ub,number:function(a,c,d,e,g,f){ub(a,c,d,e,g,f),e.$parsers.push(function(a){var c=e.$isEmpty(a);return c||Qe.test(a)?(e.$setValidity("number",!0),""===a?null:c?a:parseFloat(a)):(e.$setValidity("number",!1),s)}),Je(e,"number",c),e.$formatters.push(function(a){return e.$isEmpty(a)?"":""+a}),d.min&&(a=function(a){var c=parseFloat(d.min);return pa(e,"min",e.$isEmpty(a)||a>=c,a)},e.$parsers.push(a),e.$formatters.push(a)),d.max&&(a=function(a){var c=parseFloat(d.max);return pa(e,"max",e.$isEmpty(a)||c>=a,a)},e.$parsers.push(a),e.$formatters.push(a)),e.$formatters.push(function(a){return pa(e,"number",e.$isEmpty(a)||vb(a),a)})},url:function(a,c,d,e,g,f){ub(a,c,d,e,g,f),a=function(a){return pa(e,"url",e.$isEmpty(a)||Oe.test(a),a)},e.$formatters.push(a),e.$parsers.push(a)},email:function(a,c,d,e,g,f){ub(a,c,d,e,g,f),a=function(a){return pa(e,"email",e.$isEmpty(a)||Pe.test(a),a)},e.$formatters.push(a),e.$parsers.push(a)},tag:function(a,c,d,e){E(d.name)&&c.attr("name",bb()),c.on("click",function(){c[0].checked&&a.$apply(function(){e.$setViewValue(d.value)})}),e.$render=function(){c[0].checked=d.value==e.$viewValue},d.$observe("value",e.$render)},checkbox:function(a,c,d,e){var g=d.ngTrueValue,f=d.ngFalseValue;w(g)||(g=!0),w(f)||(f=!1),c.on("click",function(){a.$apply(function(){e.$setViewValue(c[0].checked)})}),e.$render=function(){c[0].checked=e.$viewValue},e.$isEmpty=function(a){return a!==g},e.$formatters.push(function(a){return a===g}),e.$parsers.push(function(a){return a?g:f})},hidden:C,button:C,submit:C,reset:C,file:C},dc=["$browser","$sniffer",function(a,c){return{restrict:"E",require:"?ngModel",link:function(d,e,g,f){f&&(Rc[K(g.type)]||Rc.text)(d,e,g,f,c,a)}}}],rb="ng-valid",qb="ng-invalid",La="ng-pristine",tb="ng-dirty",Re=["$scope","$exceptionHandler","$attrs","$element","$parse","$animate",function(a,c,d,e,g,f){function h(a,c){c=c?"-"+fb(c,"-"):"",f.removeClass(e,(a?qb:rb)+c),f.addClass(e,(a?rb:qb)+c)}this.$modelValue=this.$viewValue=Number.NaN,this.$parsers=[],this.$formatters=[],this.$viewChangeListeners=[],this.$pristine=!0,this.$dirty=!1,this.$valid=!0,this.$invalid=!1,this.$name=d.name;var l=g(d.ngModel),k=l.assign;if(!k)throw t("ngModel")("nonassign",d.ngModel,ha(e));this.$render=C,this.$isEmpty=function(a){return E(a)||""===a||null===a||a!==a};var m=e.inheritedData("$formController")||sb,n=0,p=this.$error={};e.addClass(La),h(!0),this.$setValidity=function(a,c){p[a]!==!c&&(c?(p[a]&&n--,n||(h(!0),this.$valid=!0,this.$invalid=!1)):(h(!1),this.$invalid=!0,this.$valid=!1,n++),p[a]=!c,h(c,a),m.$setValidity(a,c,this))},this.$setPristine=function(){this.$dirty=!1,this.$pristine=!0,f.removeClass(e,tb),f.addClass(e,La)},this.$setViewValue=function(d){this.$viewValue=d,this.$pristine&&(this.$dirty=!0,this.$pristine=!1,f.removeClass(e,La),f.addClass(e,tb),m.$setDirty()),q(this.$parsers,function(a){d=a(d)}),this.$modelValue!==d&&(this.$modelValue=d,k(a,d),q(this.$viewChangeListeners,function(a){try{a()}catch(d){c(d)}}))};var r=this;a.$watch(function(){var c=l(a);if(r.$modelValue!==c){var d=r.$formatters,e=d.length;for(r.$modelValue=c;e--;)c=d[e](c);r.$viewValue!==c&&(r.$viewValue=c,r.$render())}return c})}],Fd=function(){return{require:["ngModel","^?form"],controller:Re,link:function(a,c,d,e){var g=e[0],f=e[1]||sb;f.$addControl(g),a.$on("$destroy",function(){f.$removeControl(g)})}}},Hd=aa({require:"ngModel",link:function(a,c,d,e){e.$viewChangeListeners.push(function(){a.$eval(d.ngChange)})}}),ec=function(){return{require:"?ngModel",link:function(a,c,d,e){if(e){d.required=!0;var g=function(a){return d.required&&e.$isEmpty(a)?void e.$setValidity("required",!1):(e.$setValidity("required",!0),a)};e.$formatters.push(g),e.$parsers.unshift(g),d.$observe("required",function(){g(e.$viewValue)})}}}},Gd=function(){return{require:"ngModel",link:function(a,c,d,e){var g=(a=/\/(.*)\//.exec(d.ngList))&&RegExp(a[1])||d.ngList||",";e.$parsers.push(function(a){if(!E(a)){var c=[];return a&&q(a.split(g),function(a){a&&c.push(ca(a))}),c}}),e.$formatters.push(function(a){return M(a)?a.join(", "):s}),e.$isEmpty=function(a){return!a||!a.length}}}},Se=/^(true|false|\d+)$/,Id=function(){return{priority:100,compile:function(a,c){return Se.test(c.ngValue)?function(a,c,g){g.$set("value",a.$eval(g.ngValue))}:function(a,c,g){a.$watch(g.ngValue,function(a){g.$set("value",a)})}}}},id=va(function(a,c,d){c.addClass("ng-binding").data("$binding",d.ngBind),a.$watch(d.ngBind,function(a){c.text(a==s?"":a)})}),kd=["$interpolate",function(a){return function(c,d,e){c=a(d.attr(e.$attr.ngBindTemplate)),d.addClass("ng-binding").data("$binding",c),e.$observe("ngBindTemplate",function(a){d.text(a)})}}],jd=["$sce","$parse",function(a,c){return function(d,e,g){e.addClass("ng-binding").data("$binding",g.ngBindHtml);var f=c(g.ngBindHtml);d.$watch(function(){return(f(d)||"").toString()},function(){e.html(a.getTrustedHtml(f(d))||"")})}}],ld=Pb("",!0),nd=Pb("Odd",0),md=Pb("Even",1),od=va({compile:function(a,c){c.$set("ngCloak",s),a.removeClass("ng-cloak")}}),pd=[function(){return{scope:!0,controller:"@",priority:500}}],fc={};q("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),function(a){var c=na("ng-"+a);fc[c]=["$parse",function(d){return{compile:function(e,g){var f=d(g[c]);return function(c,d){d.on(K(a),function(a){c.$apply(function(){f(c,{$event:a})})})}}}}]});var sd=["$animate",function(a){return{transclude:"element",priority:600,terminal:!0,restrict:"A",$$tlb:!0,link:function(c,d,e,g,f){var h,l,k;c.$watch(e.ngIf,function(g){Qa(g)?l||(l=c.$new(),f(l,function(c){c[c.length++]=U.createComment(" end ngIf: "+e.ngIf+" "),h={clone:c},a.enter(c,d.parent(),d)})):(k&&(k.remove(),k=null),l&&(l.$destroy(),l=null),h&&(k=yb(h.clone),a.leave(k,function(){k=null}),h=null))})}}}],td=["$http","$templateCache","$anchorScroll","$animate","$sce",function(a,c,d,e,g){return{restrict:"ECA",priority:400,terminal:!0,transclude:"element",controller:Ea.noop,compile:function(f,h){var l=h.ngInclude||h.src,k=h.onload||"",m=h.autoscroll;return function(f,h,q,s,u){var v,y,A,F=0,x=function(){y&&(y.remove(),y=null),v&&(v.$destroy(),v=null),A&&(e.leave(A,function(){y=null}),y=A,A=null)};f.$watch(g.parseAsResourceUrl(l),function(g){var l=function(){!B(m)||m&&!f.$eval(m)||d()},q=++F;g?(a.get(g,{cache:c}).success(function(a){if(q===F){var c=f.$new();s.template=a,a=u(c,function(a){x(),e.enter(a,null,h,l)}),v=c,A=a,v.$emit("$includeContentLoaded"),f.$eval(k)}}).error(function(){q===F&&x()}),f.$emit("$includeContentRequested")):(x(),s.template=null)})}}}}],Jd=["$compile",function(a){return{restrict:"ECA",priority:-400,require:"ngInclude",link:function(c,d,e,g){d.html(g.template),a(d.contents())(c)}}}],ud=va({priority:450,compile:function(){return{pre:function(a,c,d){a.$eval(d.ngInit)}}}}),vd=va({terminal:!0,priority:1e3}),wd=["$locale","$interpolate",function(a,c){var d=/{}/g;return{restrict:"EA",link:function(e,g,f){var h=f.count,l=f.$attr.when&&g.attr(f.$attr.when),k=f.offset||0,m=e.$eval(l)||{},n={},p=c.startSymbol(),r=c.endSymbol(),s=/^when(Minus)?(.+)$/;q(f,function(a,c){s.test(c)&&(m[K(c.replace("when","").replace("Minus","-"))]=g.attr(f.$attr[c]))}),q(m,function(a,e){n[e]=c(a.replace(d,p+h+"-"+k+r))}),e.$watch(function(){var c=parseFloat(e.$eval(h));return isNaN(c)?"":(c in m||(c=a.pluralCat(c-k)),n[c](e,g,!0))},function(a){g.text(a)})}}}],xd=["$parse","$animate",function(a,c){var d=t("ngRepeat");return{transclude:"element",priority:1e3,terminal:!0,$$tlb:!0,link:function(e,g,f,h,l){var n,p,r,s,u,F,k=f.ngRepeat,m=k.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/),v={$id:Ia};if(!m)throw d("iexp",k);if(f=m[1],h=m[2],(m=m[3])?(n=a(m),p=function(a,c,d){return F&&(v[F]=a),v[u]=c,v.$index=d,n(e,v)}):(r=function(a,c){return Ia(c)},s=function(a){return a}),m=f.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/),!m)throw d("iidexp",f);u=m[3]||m[1],F=m[2];var B={};e.$watchCollection(h,function(a){var f,h,n,H,R,w,C,T,t,m=g[0],v={},E=[];if(ab(a))T=a,n=p||r;else{n=p||s,T=[];for(w in a)a.hasOwnProperty(w)&&"$"!=w.charAt(0)&&T.push(w);T.sort()}for(H=T.length,h=E.length=T.length,f=0;h>f;f++)if(w=a===T?f:T[f],C=a[w],C=n(w,C,f),Aa(C,"`track by` id"),B.hasOwnProperty(C))t=B[C],delete B[C],v[C]=t,E[f]=t;
else{if(v.hasOwnProperty(C))throw q(E,function(a){a&&a.scope&&(B[a.id]=a)}),d("dupes",k,C);E[f]={id:C},v[C]=!1}for(w in B)B.hasOwnProperty(w)&&(t=B[w],f=yb(t.clone),c.leave(f),q(f,function(a){a.$$NG_REMOVED=!0}),t.scope.$destroy());for(f=0,h=T.length;h>f;f++){if(w=a===T?f:T[f],C=a[w],t=E[f],E[f-1]&&(m=E[f-1].clone[E[f-1].clone.length-1]),t.scope){R=t.scope,n=m;do n=n.nextSibling;while(n&&n.$$NG_REMOVED);t.clone[0]!=n&&c.move(yb(t.clone),null,y(m)),m=t.clone[t.clone.length-1]}else R=e.$new();R[u]=C,F&&(R[F]=w),R.$index=f,R.$first=0===f,R.$last=f===H-1,R.$middle=!(R.$first||R.$last),R.$odd=!(R.$even=0===(1&f)),t.scope||l(R,function(a){a[a.length++]=U.createComment(" end ngRepeat: "+k+" "),c.enter(a,null,y(m)),m=a,t.scope=R,t.clone=a,v[t.id]=t})}B=v})}}}],yd=["$animate",function(a){return function(c,d,e){c.$watch(e.ngShow,function(c){a[Qa(c)?"removeClass":"addClass"](d,"ng-hide")})}}],rd=["$animate",function(a){return function(c,d,e){c.$watch(e.ngHide,function(c){a[Qa(c)?"addClass":"removeClass"](d,"ng-hide")})}}],zd=va(function(a,c,d){a.$watch(d.ngStyle,function(a,d){d&&a!==d&&q(d,function(a,d){c.css(d,"")}),a&&c.css(a)},!0)}),Ad=["$animate",function(a){return{restrict:"EA",require:"ngSwitch",controller:["$scope",function(){this.cases={}}],link:function(c,d,e,g){var f,h,l,k=[];c.$watch(e.ngSwitch||e.on,function(d){var n,p=k.length;if(p>0){if(l){for(n=0;p>n;n++)l[n].remove();l=null}for(l=[],n=0;p>n;n++){var r=h[n];k[n].$destroy(),l[n]=r,a.leave(r,function(){l.splice(n,1),0===l.length&&(l=null)})}}h=[],k=[],(f=g.cases["!"+d]||g.cases["?"])&&(c.$eval(e.change),q(f,function(d){var e=c.$new();k.push(e),d.transclude(e,function(c){var e=d.element;h.push(c),a.enter(c,e.parent(),e)})}))})}}}],Bd=va({transclude:"element",priority:800,require:"^ngSwitch",link:function(a,c,d,e,g){e.cases["!"+d.ngSwitchWhen]=e.cases["!"+d.ngSwitchWhen]||[],e.cases["!"+d.ngSwitchWhen].push({transclude:g,element:c})}}),Cd=va({transclude:"element",priority:800,require:"^ngSwitch",link:function(a,c,d,e,g){e.cases["?"]=e.cases["?"]||[],e.cases["?"].push({transclude:g,element:c})}}),Ed=va({link:function(a,c,d,e,g){if(!g)throw t("ngTransclude")("orphan",ha(c));g(function(a){c.empty(),c.append(a)})}}),ed=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(c,d){"text/ng-template"==d.type&&a.put(d.id,c[0].text)}}}],Te=t("ngOptions"),Dd=aa({terminal:!0}),fd=["$compile","$parse",function(a,c){var d=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,e={$setViewValue:C};return{restrict:"E",require:["select","?ngModel"],controller:["$element","$scope","$attrs",function(a,c,d){var n,l=this,k={},m=e;l.databound=d.ngModel,l.init=function(a,c,d){m=a,n=d},l.addOption=function(c){Aa(c,'"option value"'),k[c]=!0,m.$viewValue==c&&(a.val(c),n.parent()&&n.remove())},l.removeOption=function(a){this.hasOption(a)&&(delete k[a],m.$viewValue==a&&this.renderUnknownOption(a))},l.renderUnknownOption=function(c){c="? "+Ia(c)+" ?",n.val(c),a.prepend(n),a.val(c),n.prop("selected",!0)},l.hasOption=function(a){return k.hasOwnProperty(a)},c.$on("$destroy",function(){l.renderUnknownOption=C})}],link:function(e,f,h,l){function k(a,c,d,e){d.$render=function(){var a=d.$viewValue;e.hasOption(a)?(A.parent()&&A.remove(),c.val(a),""===a&&w.prop("selected",!0)):E(a)&&w?c.val(""):e.renderUnknownOption(a)},c.on("change",function(){a.$apply(function(){A.parent()&&A.remove(),d.$setViewValue(c.val())})})}function m(a,c,d){var e;d.$render=function(){var a=new Va(d.$viewValue);q(c.find("option"),function(c){c.selected=B(a.get(c.value))})},a.$watch(function(){xa(e,d.$viewValue)||(e=ba(d.$viewValue),d.$render())}),c.on("change",function(){a.$apply(function(){var a=[];q(c.find("option"),function(c){c.selected&&a.push(c.value)}),d.$setViewValue(a)})})}function n(e,f,g){function h(){var d,k,s,t,z,a={"":[]},c=[""];t=g.$modelValue,z=y(e)||[];var F,I,A,E=n?Qb(z):z;I={},s=!1;var D,H;if(r)if(w&&M(t))for(s=new Va([]),A=0;A<t.length;A++)I[m]=t[A],s.put(w(e,I),t[A]);else s=new Va(t);for(A=0;F=E.length,F>A;A++){if(k=A,n){if(k=E[A],"$"===k.charAt(0))continue;I[n]=k}I[m]=z[k],d=p(e,I)||"",(k=a[d])||(k=a[d]=[],c.push(d)),r?d=B(s.remove(w?w(e,I):q(e,I))):(w?(d={},d[m]=t,d=w(e,d)===w(e,I)):d=t===q(e,I),s=s||d),D=l(e,I),D=B(D)?D:"",k.push({id:w?w(e,I):n?E[A]:A,label:D,selected:d})}for(r||(u||null===t?a[""].unshift({id:"",label:"",selected:!s}):s||a[""].unshift({id:"?",label:"",selected:!0})),I=0,E=c.length;E>I;I++){for(d=c[I],k=a[d],x.length<=I?(t={element:C.clone().attr("label",d),label:k.label},z=[t],x.push(z),f.append(t.element)):(z=x[I],t=z[0],t.label!=d&&t.element.attr("label",t.label=d)),D=null,A=0,F=k.length;F>A;A++)s=k[A],(d=z[A+1])?(D=d.element,d.label!==s.label&&D.text(d.label=s.label),d.id!==s.id&&D.val(d.id=s.id),d.selected!==s.selected&&D.prop("selected",d.selected=s.selected)):(""===s.id&&u?H=u:(H=v.clone()).val(s.id).attr("selected",s.selected).text(s.label),z.push({element:H,label:s.label,id:s.id,selected:s.selected}),D?D.after(H):t.element.append(H),D=H);for(A++;z.length>A;)z.pop().element.remove()}for(;x.length>I;)x.pop()[0].element.remove()}var k;if(!(k=t.match(d)))throw Te("iexp",t,ha(f));var l=c(k[2]||k[1]),m=k[4]||k[6],n=k[5],p=c(k[3]||""),q=c(k[2]?k[1]:m),y=c(k[7]),w=k[8]?c(k[8]):null,x=[[{element:f,label:""}]];u&&(a(u)(e),u.removeClass("ng-scope"),u.remove()),f.empty(),f.on("change",function(){e.$apply(function(){var a,h,k,l,p,t,v,u,c=y(e)||[],d={};if(r){for(k=[],p=0,v=x.length;v>p;p++)for(a=x[p],l=1,t=a.length;t>l;l++)if((h=a[l].element)[0].selected){if(h=h.val(),n&&(d[n]=h),w)for(u=0;u<c.length&&(d[m]=c[u],w(e,d)!=h);u++);else d[m]=c[h];k.push(q(e,d))}}else{if(h=f.val(),"?"==h)k=s;else if(""===h)k=null;else if(w){for(u=0;u<c.length;u++)if(d[m]=c[u],w(e,d)==h){k=q(e,d);break}}else d[m]=c[h],n&&(d[n]=h),k=q(e,d);1<x[0].length&&x[0][1].id!==h&&(x[0][1].selected=!1)}g.$setViewValue(k)})}),g.$render=h,e.$watch(h)}if(l[1]){var p=l[0];l=l[1];var w,r=h.multiple,t=h.ngOptions,u=!1,v=y(U.createElement("option")),C=y(U.createElement("optgroup")),A=v.clone();h=0;for(var x=f.children(),D=x.length;D>h;h++)if(""===x[h].value){w=u=x.eq(h);break}p.init(l,u,A),r&&(l.$isEmpty=function(a){return!a||0===a.length}),t?n(e,f,l):r?m(e,f,l):k(e,f,l,p)}}}}],hd=["$interpolate",function(a){var c={addOption:C,removeOption:C};return{restrict:"E",priority:100,compile:function(d,e){if(E(e.value)){var g=a(d.text(),!0);g||e.$set("value",d.text())}return function(a,d,e){var k=d.parent(),m=k.data("$selectController")||k.parent().data("$selectController");m&&m.databound?d.prop("selected",!1):m=c,g?a.$watch(g,function(a,c){e.$set("value",a),a!==c&&m.removeOption(c),m.addOption(a)}):m.addOption(e.value),d.on("$destroy",function(){m.removeOption(e.value)})}}}}],gd=aa({restrict:"E",terminal:!0});O.angular.bootstrap?console.log("WARNING: Tried to load angular more than once."):((Ga=O.jQuery)?(y=Ga,D(Ga.fn,{scope:Ja.scope,isolateScope:Ja.isolateScope,controller:Ja.controller,injector:Ja.injector,inheritedData:Ja.inheritedData}),Ab("remove",!0,!0,!1),Ab("empty",!1,!1,!1),Ab("html",!1,!1,!0)):y=N,Ea.element=y,Zc(Ea),y(U).ready(function(){Wc(U,$b)}))}(window,document),!angular.$$csp()&&angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}</style>'),function(window,angular){"use strict";function makeSwipeDirective(directiveName,direction,eventName){ngTouch.directive(directiveName,["$parse","$swipe",function($parse,$swipe){var MAX_VERTICAL_DISTANCE=75,MAX_VERTICAL_RATIO=.3,MIN_HORIZONTAL_DISTANCE=30;return function(scope,element,attr){function validSwipe(coords){if(!startCoords)return!1;var deltaY=Math.abs(coords.y-startCoords.y),deltaX=(coords.x-startCoords.x)*direction;return valid&&MAX_VERTICAL_DISTANCE>deltaY&&deltaX>0&&deltaX>MIN_HORIZONTAL_DISTANCE&&MAX_VERTICAL_RATIO>deltaY/deltaX}var startCoords,valid,swipeHandler=$parse(attr[directiveName]);$swipe.bind(element,{start:function(coords){startCoords=coords,valid=!0},cancel:function(){valid=!1},end:function(coords,event){validSwipe(coords)&&scope.$apply(function(){element.triggerHandler(eventName),swipeHandler(scope,{$event:event})})}})}}])}var ngTouch=angular.module("ngTouch",[]);ngTouch.factory("$swipe",[function(){function getCoordinates(event){var touches=event.touches&&event.touches.length?event.touches:[event],e=event.changedTouches&&event.changedTouches[0]||event.originalEvent&&event.originalEvent.changedTouches&&event.originalEvent.changedTouches[0]||touches[0].originalEvent||touches[0];return{x:e.clientX,y:e.clientY}}var MOVE_BUFFER_RADIUS=10;return{bind:function(element,eventHandlers){var totalX,totalY,startCoords,lastPos,active=!1;element.on("touchstart mousedown",function(event){startCoords=getCoordinates(event),active=!0,totalX=0,totalY=0,lastPos=startCoords,eventHandlers.start&&eventHandlers.start(startCoords,event)}),element.on("touchcancel",function(event){active=!1,eventHandlers.cancel&&eventHandlers.cancel(event)}),element.on("touchmove mousemove",function(event){if(active&&startCoords){var coords=getCoordinates(event);if(totalX+=Math.abs(coords.x-lastPos.x),totalY+=Math.abs(coords.y-lastPos.y),lastPos=coords,!(MOVE_BUFFER_RADIUS>totalX&&MOVE_BUFFER_RADIUS>totalY))return totalY>totalX?(active=!1,void(eventHandlers.cancel&&eventHandlers.cancel(event))):(event.preventDefault(),void(eventHandlers.move&&eventHandlers.move(coords,event)))}}),element.on("touchend mouseup",function(event){active&&(active=!1,eventHandlers.end&&eventHandlers.end(getCoordinates(event),event))})}}}]),ngTouch.config(["$provide",function($provide){$provide.decorator("ngClickDirective",["$delegate",function($delegate){return $delegate.shift(),$delegate}])}]),ngTouch.directive("ngClick",["$parse","$timeout","$rootElement",function($parse,$timeout,$rootElement){function hit(x1,y1,x2,y2){return Math.abs(x1-x2)<CLICKBUSTER_THRESHOLD&&Math.abs(y1-y2)<CLICKBUSTER_THRESHOLD}function checkAllowableRegions(touchCoordinates,x,y){for(var i=0;i<touchCoordinates.length;i+=2)if(hit(touchCoordinates[i],touchCoordinates[i+1],x,y))return touchCoordinates.splice(i,i+2),!0;return!1}function onClick(event){if(!(Date.now()-lastPreventedTime>PREVENT_DURATION)){var touches=event.touches&&event.touches.length?event.touches:[event],x=touches[0].clientX,y=touches[0].clientY;1>x&&1>y||lastLabelClickCoordinates&&lastLabelClickCoordinates[0]===x&&lastLabelClickCoordinates[1]===y||(lastLabelClickCoordinates&&(lastLabelClickCoordinates=null),"label"===event.target.tagName.toLowerCase()&&(lastLabelClickCoordinates=[x,y]),checkAllowableRegions(touchCoordinates,x,y)||(event.stopPropagation(),event.preventDefault(),event.target&&event.target.blur()))}}function onTouchStart(event){var touches=event.touches&&event.touches.length?event.touches:[event],x=touches[0].clientX,y=touches[0].clientY;touchCoordinates.push(x,y),$timeout(function(){for(var i=0;i<touchCoordinates.length;i+=2)if(touchCoordinates[i]==x&&touchCoordinates[i+1]==y)return void touchCoordinates.splice(i,i+2)},PREVENT_DURATION,!1)}function preventGhostClick(x,y){touchCoordinates||($rootElement[0].addEventListener("click",onClick,!0),$rootElement[0].addEventListener("touchstart",onTouchStart,!0),touchCoordinates=[]),lastPreventedTime=Date.now(),checkAllowableRegions(touchCoordinates,x,y)}var lastPreventedTime,touchCoordinates,lastLabelClickCoordinates,TAP_DURATION=750,MOVE_TOLERANCE=12,PREVENT_DURATION=2500,CLICKBUSTER_THRESHOLD=25,ACTIVE_CLASS_NAME="ng-click-active";return function(scope,element,attr){function resetState(){tapping=!1,element.removeClass(ACTIVE_CLASS_NAME)}var tapElement,startTime,touchStartX,touchStartY,clickHandler=$parse(attr.ngClick),tapping=!1;element.on("touchstart",function(event){tapping=!0,tapElement=event.target?event.target:event.srcElement,3==tapElement.nodeType&&(tapElement=tapElement.parentNode),element.addClass(ACTIVE_CLASS_NAME),startTime=Date.now();var touches=event.touches&&event.touches.length?event.touches:[event],e=touches[0].originalEvent||touches[0];touchStartX=e.clientX,touchStartY=e.clientY}),element.on("touchmove",function(){resetState()}),element.on("touchcancel",function(){resetState()}),element.on("touchend",function(event){var diff=Date.now()-startTime,touches=event.changedTouches&&event.changedTouches.length?event.changedTouches:event.touches&&event.touches.length?event.touches:[event],e=touches[0].originalEvent||touches[0],x=e.clientX,y=e.clientY,dist=Math.sqrt(Math.pow(x-touchStartX,2)+Math.pow(y-touchStartY,2));tapping&&TAP_DURATION>diff&&MOVE_TOLERANCE>dist&&(preventGhostClick(x,y),tapElement&&tapElement.blur(),angular.isDefined(attr.disabled)&&attr.disabled!==!1||element.triggerHandler("click",[event])),resetState()}),element.onclick=function(){},element.on("click",function(event,touchend){scope.$apply(function(){clickHandler(scope,{$event:touchend||event})})}),element.on("mousedown",function(){element.addClass(ACTIVE_CLASS_NAME)}),element.on("mousemove mouseup",function(){element.removeClass(ACTIVE_CLASS_NAME)})}}]),makeSwipeDirective("ngSwipeLeft",-1,"swipeleft"),makeSwipeDirective("ngSwipeRight",1,"swiperight")}(window,window.angular);var SpotifyWebApi=function(){"use strict";var _baseUri="https://api.spotify.com/v1",_accessToken=null,_promiseImplementation=null,_promiseProvider=function(promiseFunction){if(null!==_promiseImplementation){var deferred=_promiseImplementation.defer();return promiseFunction(function(resolvedResult){deferred.resolve(resolvedResult)},function(rejectedResult){deferred.reject(rejectedResult)}),deferred.promise}return window.Promise?new window.Promise(promiseFunction):null},_checkParamsAndPerformRequest=function(requestData,options,callback){var opt={},cb=null;return"object"==typeof options?(opt=options,cb=callback):"function"==typeof options&&(cb=options),requestData.params=_extend(requestData.params,opt),_performRequest(requestData,cb)},_performRequest=function(requestData,callback){var promiseFunction=function(resolve,reject){var req=new XMLHttpRequest,type=requestData.type||"GET";"GET"===type?req.open(type,_buildUrl(requestData.url,requestData.params),!0):req.open(type,_buildUrl(requestData.url)),_accessToken&&req.setRequestHeader("Authorization","Bearer "+_accessToken),req.onreadystatechange=function(){if(4===req.readyState){var data=null;try{data=req.responseText?JSON.parse(req.responseText):""}catch(e){}200===req.status||201===req.status?(resolve&&resolve(data),callback&&callback(null,data)):(reject&&reject(req),callback&&callback(req,null))}},req.send("GET"===type?null:JSON.stringify(requestData.postData))};return callback?(promiseFunction(),null):_promiseProvider(promiseFunction)},_extend=function(){var args=Array.prototype.slice.call(arguments),target=args[0],objects=args.slice(1);target=target||{};for(var i=0;i<objects.length;i++)for(var j in objects[i])target[j]=objects[i][j];return target},_buildUrl=function(url,parameters){var qs="";for(var key in parameters)if(parameters.hasOwnProperty(key)){var value=parameters[key];qs+=encodeURIComponent(key)+"="+encodeURIComponent(value)+"&"}return qs.length>0&&(qs=qs.substring(0,qs.length-1),url=url+"?"+qs),url},Constr=function(){};return Constr.prototype={constructor:SpotifyWebApi},Constr.prototype.getGeneric=function(url,callback){var requestData={url:url};return _checkParamsAndPerformRequest(requestData,callback)},Constr.prototype.getMe=function(options,callback){var requestData={url:_baseUri+"/me"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getMySavedTracks=function(options,callback){var requestData={url:_baseUri+"/me/tracks"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.addToMySavedTracks=function(trackIds,options,callback){var requestData={url:_baseUri+"/me/tracks",type:"PUT",postData:trackIds};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.removeFromMySavedTracks=function(trackIds,options,callback){var requestData={url:_baseUri+"/me/tracks",type:"DELETE",postData:trackIds};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.containsMySavedTracks=function(trackIds,options,callback){var requestData={url:_baseUri+"/me/tracks/contains",params:{ids:trackIds.join(",")}};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getUser=function(userId,options,callback){var requestData={url:_baseUri+"/users/"+userId};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getUserPlaylists=function(userId,options,callback){var requestData={url:_baseUri+"/users/"+userId+"/playlists"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getPlaylist=function(userId,playlistId,options,callback){var requestData={url:_baseUri+"/users/"+userId+"/playlists/"+playlistId};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getPlaylistTracks=function(userId,playlistId,options,callback){var requestData={url:_baseUri+"/users/"+userId+"/playlists/"+playlistId+"/tracks"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.createPlaylist=function(userId,options,callback){var requestData={url:_baseUri+"/users/"+userId+"/playlists",type:"POST",postData:options};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.changePlaylistDetails=function(userId,playlistId,data,callback){var requestData={url:_baseUri+"/users/"+userId+"/playlists/"+playlistId,type:"PUT",postData:data};return _checkParamsAndPerformRequest(requestData,data,callback)},Constr.prototype.addTracksToPlaylist=function(userId,playlistId,uris,options,callback){var requestData={url:_baseUri+"/users/"+userId+"/playlists/"+playlistId+"/tracks",type:"POST",postData:uris};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.replaceTracksInPlaylist=function(userId,playlistId,uris,callback){var requestData={url:_baseUri+"/users/"+userId+"/playlists/"+playlistId+"/tracks",type:"PUT",postData:{uris:uris}};return _checkParamsAndPerformRequest(requestData,{},callback)},Constr.prototype.removeTracksFromPlaylist=function(userId,playlistId,uris,callback){var dataToBeSent=uris.map(function(uri){return"string"==typeof uri?{uri:uri}:uri}),requestData={url:_baseUri+"/users/"+userId+"/playlists/"+playlistId+"/tracks",type:"DELETE",postData:{tracks:dataToBeSent}};return _checkParamsAndPerformRequest(requestData,{},callback)},Constr.prototype.removeTracksFromPlaylistWithSnapshotId=function(userId,playlistId,uris,snapshotId,callback){var dataToBeSent=uris.map(function(uri){return"string"==typeof uri?{uri:uri}:uri}),requestData={url:_baseUri+"/users/"+userId+"/playlists/"+playlistId+"/tracks",type:"DELETE",postData:{tracks:dataToBeSent,snapshot_id:snapshotId}};return _checkParamsAndPerformRequest(requestData,{},callback)},Constr.prototype.getAlbum=function(albumId,options,callback){var requestData={url:_baseUri+"/albums/"+albumId};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getAlbumTracks=function(albumId,options,callback){var requestData={url:_baseUri+"/albums/"+albumId+"/tracks"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getAlbums=function(albumIds,options,callback){var requestData={url:_baseUri+"/albums/",params:{ids:albumIds.join(",")}};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getTrack=function(trackId,options,callback){var requestData={};return requestData.url=_baseUri+"/tracks/"+trackId,_checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getTracks=function(trackIds,options,callback){var requestData={url:_baseUri+"/tracks/",params:{ids:trackIds.join(",")}};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getArtist=function(artistId,options,callback){var requestData={url:_baseUri+"/artists/"+artistId};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getArtists=function(artistIds,options,callback){var requestData={url:_baseUri+"/artists/",params:{ids:artistIds.join(",")}};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getArtistAlbums=function(artistId,options,callback){var requestData={url:_baseUri+"/artists/"+artistId+"/albums"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getArtistTopTracks=function(artistId,countryId,options,callback){var requestData={url:_baseUri+"/artists/"+artistId+"/top-tracks",params:{country:countryId}};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getArtistRelatedArtists=function(artistId,options,callback){var requestData={url:_baseUri+"/artists/"+artistId+"/related-artists"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getFeaturedPlaylists=function(options,callback){var requestData={url:_baseUri+"/browse/featured-playlists"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.getNewReleases=function(options,callback){var requestData={url:_baseUri+"/browse/new-releases"};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.searchAlbums=function(query,options,callback){var requestData={url:_baseUri+"/search/",params:{q:query,type:"album"}};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.searchArtists=function(query,options,callback){var requestData={url:_baseUri+"/search/",params:{q:query,type:"artist"}};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.searchTracks=function(query,options,callback){var requestData={url:_baseUri+"/search/",params:{q:query,type:"track"}};return _checkParamsAndPerformRequest(requestData,options,callback)},Constr.prototype.setAccessToken=function(accessToken){_accessToken=accessToken},Constr.prototype.setPromiseImplementation=function(promiseImplementation){if(!("defer"in promiseImplementation))throw new Error("Unsupported implementation of Promises/A+");_promiseImplementation=promiseImplementation},Constr}(),nodspot=angular.module("nodspot",["ngTouch"]);nodspot.constant("EventsConstants",{playlistReady:"playlistReady",trackChanged:"trackChanged",releasesReturned:"releasesReturned",similarArtistsReturned:"similarArtistsReturned",artistBioReturned:"artistBioReturned",trackInfoCaptured:"trackInfoCaptured",releaseFavourited:"releaseFavourited",mainCtrlClicked:"mainCtrlClicked",requestStarted:"requestStarted",showPlayer:"showPlayer"}),nodspot.constant("MessagesConstants",{deletePlaylist:"You're going to delete this playlist. This action cannot be undone."}),nodspot.constant("LoginConstants",{fbLogin:"Sign in with Facebook",fbLogout:"Sign out from Facebook"}),nodspot.constant("ApiConstants",{baseUrlNodspot:"apis/public/index.php/"}),nodspot.controller("MainCtrl",["$scope","EventsConstants","$location","ReleasesServices","FacebookServices","FavouritesServices","PlayerServices","SearchServices","ArtistServices","LastfmServices",function($scope,EventsConstants,$location,ReleasesServices,FacebookServices,FavouritesServices,PlayerServices,SearchServices,ArtistServices,LastfmServices){$scope.appBackground="mainBackground",$scope.progressBarVisibility=!0,FacebookServices.isSDKLoaded(),$scope.$on(EventsConstants.playlistReady,function(){$scope.appBackground="searchBackground",$scope.progressBarVisibility=!1}),$scope.$watch(SearchServices.getProgressBarVisibility,function(){$scope.progressBarVisibility=SearchServices.getProgressBarVisibility()}),$scope.$on(EventsConstants.showPlayer,function(){$scope.appBackground="searchBackground"}),$scope.closeOverlays=function(){$scope.$broadcast(EventsConstants.mainCtrlClicked)},$scope.newUrlParser=function(){var urlParams=$location.search(),id=urlParams.id;switch((void 0!=urlParams.term||""==urlParams.term)&&(SearchServices.searchTerm=urlParams.term.replace(/-/g," ")),PlayerServices.currentlyPlaying.track=urlParams.track,urlParams.type){case"search":try{SearchServices.searchType=urlParams.searchType,ReleasesServices.getAlbumTracklist(id).then(function(tracklist){ReleasesServices.findVideos(tracklist).then(function(videos){PlayerServices.loadPlaylist(videos,PlayerServices.currentlyPlaying.track)}),ReleasesServices.findAlbums(SearchServices.searchTerm).then(function(){angular.forEach(ReleasesServices.returnedReleases,function(release){release.id==id&&(PlayerServices.currentlyPlaying.albumName=release.name)}),ReleasesServices.highlightRelease(id)})})}catch(e){}break;case"playlist":try{FavouritesServices.getPlaylistTracks(id).then(function(videos){PlayerServices.currentlyPlaying.playlistId=id,PlayerServices.loadPlaylist(videos,PlayerServices.currentlyPlaying.track)})}catch(e){}break;case"youtubePlaylist":try{FavouritesServices.getVideosFromYoutubePlaylist(id).then(function(videos){PlayerServices.loadPlaylist(videos,PlayerServices.currentlyPlaying.track)})}catch(e){}break;case"youtube":try{ReleasesServices.getVideosFromYoutube(SearchServices.searchTerm,40).then(function(videos){PlayerServices.loadPlaylist(videos,PlayerServices.currentlyPlaying.track)})}catch(e){}break;case"topTracks":try{ArtistServices.getTopTracks(SearchServices.searchTerm).then(function(videos){PlayerServices.loadPlaylist(videos,PlayerServices.currentlyPlaying.track),ReleasesServices.findAlbums(SearchServices.searchTerm).then(function(){ArtistServices.getSimilar(SearchServices.searchTerm)})})}catch(e){}break;case"tag":try{LastfmServices.getTagsTopTracksVideos(SearchServices.searchTerm).then(function(videos){PlayerServices.loadPlaylist(videos,PlayerServices.currentlyPlaying.track)})}catch(e){}}""!=SearchServices.searchTerm&&SearchServices.logSearch(SearchServices.searchTerm,urlParams.type)},$scope.newUrlParser()}]),nodspot.factory("FavouritesServices",["$http","FacebookServices","$rootScope","EventsConstants","YoutubeServices","MessagesConstants","PlayerServices","SearchServices","ApiConstants",function($http,FacebookServices,$rootScope,EventsConstants,YoutubeServices,MessagesConstants,PlayerServices,SearchServices,ApiConstants){var baseUrl=ApiConstants.baseUrlNodspot,FavouritesServices={};return FavouritesServices.trackId=void 0,FavouritesServices.trackIndex=void 0,FavouritesServices.trackTitle=void 0,FavouritesServices.tracksPlaylists=[],FavouritesServices.playlists=[],FavouritesServices.favourites=[],FavouritesServices.captureTrackInfo=function(index){var track=YoutubeServices.returnedVideos[index];FavouritesServices.trackIndex=index,FavouritesServices.trackId=track.id.videoId,FavouritesServices.trackTitle=encodeURIComponent(track.snippet.title),FavouritesServices.artistName=encodeURIComponent(track.artistName),FavouritesServices.fetchTracksPlaylists(FavouritesServices.trackId),$rootScope.$broadcast(EventsConstants.trackInfoCaptured)},FavouritesServices.fetchFavourites=function(){$http.get(baseUrl+"favourites").success(function(favourites){FavouritesServices.favourites=favourites})},FavouritesServices.getFavourites=function(){return FavouritesServices.favourites},FavouritesServices.fetchPlaylists=function(){$http.get(baseUrl+"playlists").success(function(playlists){angular.forEach(playlists,function(playlist){playlist.state="notSaved",playlist.editMode=!1}),FavouritesServices.playlists=playlists,FavouritesServices.trackId&&FavouritesServices.fetchTracksPlaylists(FavouritesServices.trackId)})},FavouritesServices.getPlaylists=function(){return FavouritesServices.playlists},FavouritesServices.fetchTracksPlaylists=function(trackId){$http.get(baseUrl+"track/"+trackId+"/belongsTo").success(function(tracksPlaylists){FavouritesServices.tracksPlaylists=tracksPlaylists})},FavouritesServices.getTracksPlaylists=function(){return FavouritesServices.tracksPlaylists},FavouritesServices.highlightTracksPlaylists=function(playlists,tracksPlaylists){angular.forEach(playlists,function(playlist){playlist.state="notSaved"}),angular.forEach(playlists,function(playlist){angular.forEach(tracksPlaylists,function(tracksPlaylist){playlist.playlist_id==tracksPlaylist.playlist_id&&(playlist.state="saved")})})},FavouritesServices.getPlaylistTracks=function(playlistId){return SearchServices.expandProgressBar(),$http.get(baseUrl+"playlist/"+playlistId).then(function(playlistTracks){var youtubeLikePlaylist=[];return angular.forEach(playlistTracks.data,function(track,i){youtubeLikePlaylist[i]={snippet:{title:decodeURI(track.track_title)},id:{videoId:track.track_id},artistName:track.artist_name}}),YoutubeServices.returnedVideos=youtubeLikePlaylist,PlayerServices.currentlyPlaying.albumName="Someone's playlist, all tracks are good",SearchServices.searchSource=SearchServices.searchSources.userPlaylist,youtubeLikePlaylist})},FavouritesServices.getVideosFromYoutubePlaylist=function(playlistId){return PlayerServices.currentlyPlaying.playlistId=playlistId,SearchServices.searchSource=SearchServices.searchSources.youtubePlaylist,YoutubeServices.getVideosFromYoutubePlaylist(playlistId)},FavouritesServices.playlistEditMode=function(index,event){event.stopPropagation(),FavouritesServices.playlists[index].editMode=0==FavouritesServices.playlists[index].editMode?!0:!1},FavouritesServices.addReleaseToFavourites=function(releaseTitle,artistName,releaseId,releaseYear,releaseType,searchTerm){return 1==FacebookServices.connected?$http.get(baseUrl+"favourites/"+releaseId+"/"+releaseType+"/"+searchTerm+"/"+releaseTitle+"/"+releaseYear+"/"+artistName+"/add").then(function(){FavouritesServices.fetchFavourites()}):void FacebookServices.login(function(){FavouritesServices.addReleaseToFavourites(releaseTitle,artistName,releaseId,releaseYear,releaseType,searchTerm).success(function(){$rootScope.$broadcast(EventsConstants.releaseFavourited)})})},FavouritesServices.renamePlaylist=function(index,playlistId,playlistName,event){return 13==event.which&&FacebookServices.isConnected()?$http.get(baseUrl+"playlist/"+playlistId+"/"+playlistName+"/update").then(function(){FavouritesServices.playlists[index].playlist_name=playlistName,FavouritesServices.playlists[index].editMode=!1}):void 0},FavouritesServices.deletePlaylist=function(index,playlistId,event){if(event.stopPropagation(),FacebookServices.isConnected()){var prompt=confirm(MessagesConstants.deletePlaylist);if(1==prompt)return $http.get(baseUrl+"playlist/"+playlistId+"/delete").then(function(){FavouritesServices.playlists.splice(index,1)})}},FavouritesServices.removeReleaseFromFavourites=function(releaseId){return FacebookServices.isConnected()?$http.get(baseUrl+"favourites/"+releaseId+"/delete"):void 0},FavouritesServices.isReleaseFavourite=function(releaseId){return $http.get(baseUrl+"favourites/"+releaseId+"/existing")},FavouritesServices.createPlaylist=function(playlistName){return FacebookServices.isConnected()?$http.get(baseUrl+"playlist/"+playlistName+"/new"):void FacebookServices.login(function(){FavouritesServices.createPlaylist(playlistName)})},FavouritesServices.createPlaylistTypeYoutube=function(playlistName,youtubePlaylistId){return FacebookServices.isConnected()?$http.get(baseUrl+"playlist/"+playlistName+"/"+youtubePlaylistId+"/new"):void FacebookServices.login(function(){FavouritesServices.createPlaylist(playlistName,youtubePlaylistId)})},FavouritesServices.addTrackToPlaylist=function(trackId,playlistId,playlistName,trackTitle,artistName){return FacebookServices.isConnected()?$http.get(baseUrl+"playlist/"+playlistId+"/"+trackId+"/"+trackTitle+"/"+artistName+"/add"):void FacebookServices.login(function(){FavouritesServices.addTrackToPlaylist(trackId,playlistId,playlistName,trackTitle)})},FavouritesServices.removeTrackFromPlaylist=function(trackId,playlistId){return FacebookServices.isConnected()?$http.get(baseUrl+"playlist/"+playlistId+"/"+trackId+"/remove"):void FacebookServices.login(function(){FavouritesServices.removeTrackFromPlaylist(trackId,playlistId)
})},FavouritesServices}]),nodspot.factory("YoutubeServices",["$http","$rootScope","EventsConstants","$window","$q",function($http,$rootScope,EventsConstants,$window,$q){var baseUrl="https://www.googleapis.com/youtube/v3/search?part=snippet",apiKey="AIzaSyCqb509HUMemkHf0fEHMiE3abVWdN-aKK0",YoutubeServices={isConnected:!1,authUrl:"https://accounts.google.com/o/oauth2/auth?",redirectUrl:"http://www.nodspot.com/ytCallback.html",scope:"https://www.googleapis.com/auth/youtube.readonly",API:"AIzaSyCqb509HUMemkHf0fEHMiE3abVWdN-aKK0",clientID:"944591291174.apps.googleusercontent.com",token:"",feedBaseUrl:"",returnedVideos:[],returnedVideosCounter:0,auth:function(){$window.open(this.authUrl+"client_id="+this.clientID+"&redirect_uri="+this.redirectUrl+"&scope="+this.scope+"&response_type=token","Google Sign in","height=500,width=500")},getUsersYoutubePlaylists:function(){var deferred=$q.defer();return YoutubeServices.getAuthTokenFromLocalStorage().then(function(token){token?deferred.resolve($http.get("https://www.googleapis.com/youtube/v3/playlists?part=snippet&mine=true&key="+YoutubeServices.API+"&access_token="+token)):(deferred.reject(!1),setTimeout(function(){YoutubeServices.getUsersYoutubePlaylists()},1e3))}),deferred.promise}};YoutubeServices.getAuthTokenFromLocalStorage=function(){var deferred=$q.defer(),ytToken=localStorage.ytToken;return deferred.resolve(""!=ytToken?ytToken:!1),deferred.promise},YoutubeServices.setPlaylistLength=function(playlistLength){YoutubeServices.returnedVideos=[],YoutubeServices.returnedVideosCounter=0,YoutubeServices.playlistLength=playlistLength},YoutubeServices.findVideos=function(tracklist,maxResults){var d=$q.defer();return"object"==typeof tracklist?YoutubeServices.setPlaylistLength(tracklist.length):tracklist=[{track_title:tracklist}],void 0==maxResults&&(maxResults=1),angular.forEach(tracklist,function(track,i){YoutubeServices.findVideo(track.artist_name,decodeURIComponent(track.track_title),i,maxResults).then(function(returnedVideos){d.resolve(returnedVideos)})}),d.promise},YoutubeServices.findVideo=function(artistName,trackName,i,maxResults){var url,d=$q.defer();return url=baseUrl+"&maxResults="+maxResults+"&q="+trackName+"&type=video&key="+apiKey,$http.get(encodeURI(url)).then(function(res){if(res.data.pageInfo.totalResults>0)switch(maxResults){case 1:YoutubeServices.returnedVideos[i]=res.data.items[0],YoutubeServices.returnedVideos[i].artistName=artistName,YoutubeServices.returnedVideosCounter++;break;case 40:angular.forEach(res.data.items,function(video,j){video.artistName=video.snippet.title.split(" -")[0],YoutubeServices.returnedVideos[j]=video,YoutubeServices.returnedVideosCounter++,YoutubeServices.playlistLength=maxResults})}else YoutubeServices.playlistLength--;YoutubeServices.returnedVideosCounter==YoutubeServices.playlistLength&&(angular.forEach(YoutubeServices.returnedVideos,function(video){video.thumbVisiblity=!1}),d.resolve(YoutubeServices.returnedVideos),YoutubeServices.returnedVideosCounter=0)}),d.promise},YoutubeServices.isValidVideo=function(videoId){var isValid,url="https://www.googleapis.com/youtube/v3/videos?part=snippet&id="+videoId+"&key="+apiKey;return $http.get(url).then(function(res){return isValid=res.data.pageInfo.totalResults>0?!0:!1})},YoutubeServices.getReturnedVideos=function(){return $rootScope.$broadcast(EventsConstants.playlistReady),YoutubeServices.returnedVideos},YoutubeServices.getVideosFromYoutubePlaylist=function(playlistId){var deferred=$q.defer();return $http.get("https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId="+playlistId+"&key="+this.API).then(function(res){var returnedVideos=[];angular.forEach(res.data.items,function(video,key){returnedVideos[key]={artistName:video.snippet.title.split(" -")[0],id:video.snippet.resourceId,snippet:video.snippet}}),YoutubeServices.returnedVideos=returnedVideos,deferred.resolve(returnedVideos)}),deferred.promise};return YoutubeServices}]),nodspot.factory("ReleasesServices",["$http","$rootScope","YoutubeServices","EventsConstants","GenresServices","ArtistServices","SearchServices","PlayerServices","$q","SpotifyServices",function($http,$rootScope,YoutubeServices,EventsConstants,GenresServices,ArtistServices,SearchServices,PlayerServices,$q,SpotifyServices){var baseUrl="releases.php?action=",ReleasesServices={returnedReleases:[]};return ReleasesServices.getReleases=function(){return ReleasesServices.returnedReleases},ReleasesServices.getSuggestions=function(searchTerm){return $http.get(baseUrl+"yt&term="+searchTerm)},ReleasesServices.findAlbums=function(searchTerm){return SearchServices.expandProgressBar(),GenresServices.stylesVisibility=!1,SpotifyServices.findAlbums(searchTerm).then(function(albums){ReleasesServices.returnedReleases=albums.albums.items})},ReleasesServices.findVideos=function(tracklist){return YoutubeServices.findVideos(tracklist)},ReleasesServices.getVideosFromYoutube=function(searchTerm,maxResults){var d=$q.defer();return SearchServices.expandProgressBar(),YoutubeServices.findVideos(searchTerm,maxResults).then(function(videos){d.resolve(videos)}),SearchServices.searchSource=SearchServices.searchSources.directYoutube,SearchServices.searchTerm=searchTerm,PlayerServices.currentlyPlaying.artistName=searchTerm,PlayerServices.currentlyPlaying.albumName="Tracks straight from youtube",d.promise},ReleasesServices.getAlbumTracklist=function(albumId){return SearchServices.expandProgressBar(),SpotifyServices.getAlbumTracks(albumId).then(function(tracklist){return ReleasesServices.convertSpotifyTracklistToNodspot(tracklist.items)})},ReleasesServices.highlightRelease=function(releaseId){angular.forEach(ReleasesServices.returnedReleases,function(release){release.state=releaseId==release.id?"active":""})},ReleasesServices.generateThumbnails=function(propertyForInitials,obj){var colour=0,colours={0:"acc1",1:"acc2",2:"acc3"},initials="",tempObj=obj;return angular.forEach(tempObj,function(item){colour=Math.floor(3*Math.random()),item.colour=colours[colour],initials=item[propertyForInitials].split(" "),item.initials=initials[0].substr(0,1)}),tempObj},ReleasesServices.convertSpotifyTracklistToNodspot=function(releaseObj){var originalTracklist=[],artistName="",trackName="",release=releaseObj;return release.artists&&(PlayerServices.currentlyPlaying.artistName=release.artists[0].name),ArtistServices.fetchImages(PlayerServices.currentlyPlaying.artistName),ArtistServices.getSimilar(PlayerServices.currentlyPlaying.artistName),PlayerServices.currentlyPlaying.albumName=release.title,PlayerServices.currentlyPlaying.releaseYear=release.year,angular.forEach(release,function(track,i){artistName=void 0!=track.artists?track.artists[0].name:release.artists[0].name,artistName=artistName.split(" (")[0],trackName=track.name,originalTracklist[i]={track_title:artistName+" "+trackName,artist_name:artistName}}),originalTracklist},ReleasesServices}]),nodspot.factory("PlayerServices",["$window","SearchServices","$location","$rootScope","HelperServices","GenresServices","EventsConstants",function($window,SearchServices,$location,$rootScope,HelperServices,GenresServices,EventsConstants){var PlayerServices={scrollY:0,playerVisibility:!1,firstTimePlay:!1};return PlayerServices.currentlyPlaying={artistName:"",albumName:"",albumId:"",releaseYear:"",searchType:"",searchTerm:"",source:"",track:0,playlistId:void 0},PlayerServices.getFirstTimePlay=function(){return PlayerServices.firstTimePlay},$window.ytPlayer=void 0,$window.onYouTubeIframeAPIReady=function(){$window.ytPlayer=new YT.Player("embeddedPlayer",{height:"100%",width:"100%",events:{onReady:PlayerServices.onReady,onStateChange:PlayerServices.onPlayerStateChanged}})},PlayerServices.getPlayerVisibility=function(){return PlayerServices.playerVisibility},PlayerServices.onReady=function(){ytPlayer.addEventListener("onStateChange",function(){}),ytPlayer.setOption("cc","cc_load_policy",0)},PlayerServices.resetCurrentlyPlaying=function(){PlayerServices.currentlyPlaying.track=0},PlayerServices.getCurrentlyPlaying=function(){return PlayerServices.currentlyPlaying},PlayerServices.onPlayerStateChanged=function(newState){return 1==newState.data||3==newState.data||5==newState.data?(PlayerServices.currentlyPlaying.track=ytPlayer.getPlaylistIndex(),$rootScope.$broadcast(EventsConstants.trackChanged),PlayerServices.updateHash()):0==newState.data||-1==newState.data,newState},PlayerServices.removeEmptyItemsFromArray=function(list){for(var cleanArray=[],i=0;i<list.length;i++)void 0!=list[i]&&""!=list[i]&&cleanArray.push(list[i]);return cleanArray},PlayerServices.updateHash=function(){var hash="",type="?type=",separator="&";switch(SearchServices.searchSource){case SearchServices.searchSources.userInput:hash=type+"search"+separator+"searchType="+SearchServices.searchType+separator+"term="+SearchServices.searchTerm+separator+"id="+PlayerServices.currentlyPlaying.albumId+separator+"track="+PlayerServices.currentlyPlaying.track;break;case SearchServices.searchSources.userPlaylist:hash=type+"playlist"+separator+"id="+PlayerServices.currentlyPlaying.playlistId+separator+"track="+PlayerServices.currentlyPlaying.track;break;case SearchServices.searchSources.surpriseMe:hash=type+"surprise"+separator+"style="+SearchServices.surprise.style+separator+"page="+SearchServices.surprise.page+separator+"id="+PlayerServices.currentlyPlaying.albumId+separator+"track="+PlayerServices.currentlyPlaying.track;break;case SearchServices.searchSources.directYoutube:hash=type+"youtube"+separator+"term="+SearchServices.searchTerm+separator+"track="+PlayerServices.currentlyPlaying.track;break;case SearchServices.searchSources.topTracks:hash=type+"topTracks"+separator+"term="+SearchServices.searchTerm+separator+"track="+PlayerServices.currentlyPlaying.track;break;case SearchServices.searchSources.tag:hash=type+"tag"+separator+"term="+SearchServices.searchTerm+separator+"track="+PlayerServices.currentlyPlaying.track;break;case SearchServices.searchSources.youtubePlaylist:hash=type+"youtubePlaylist"+separator+"id="+PlayerServices.currentlyPlaying.playlistId+separator+"track="+PlayerServices.currentlyPlaying.track}hash=hash.replace(/ /g,"-"),$location.url(hash,$location.path()),$rootScope.$digest()},PlayerServices.loadPlaylist=function(videos,startFrom){var playlistIds=HelperServices.extractVideoIds(videos);GenresServices.stylesVisibility=!1,PlayerServices.playerVisibility=!0;var interval=setInterval(function(){try{void 0!=ytPlayer.loadPlaylist&&(ytPlayer.loadPlaylist(playlistIds,startFrom),clearInterval(interval))}catch(e){}},120)},PlayerServices.playTrack=function(index){ytPlayer.setLoop(!0),ytPlayer.playVideoAt(index),PlayerServices.isFirstTimePlay()},PlayerServices.isFirstTimePlay=function(){var playsCounterLS="playsCounter",showTips="showTips";return void 0!=localStorage?void 0==localStorage[playsCounterLS]&&void 0==localStorage[showTips]?(localStorage[playsCounterLS]=1,localStorage[showTips]=1,PlayerServices.firstTimePlay=!1):1==localStorage[showTips]&&2==localStorage[playsCounterLS]?(localStorage[playsCounterLS]++,PlayerServices.firstTimePlay=!0):0==localStorage[showTips]?(localStorage[playsCounterLS]++,PlayerServices.firstTimePlay=!1):(localStorage[playsCounterLS]++,PlayerServices.firstTimePlay=!0):void 0},PlayerServices.getScrollY=function(){return PlayerServices.scrollY},PlayerServices}]),nodspot.factory("ArtistServices",["$http","$rootScope","LastfmServices","YoutubeServices","PlayerServices","SearchServices","EventsConstants","$q",function($http,$rootScope,LastfmServices,YoutubeServices,PlayerServices,SearchServices,EventsConstants,$q){var ArtistServices={artistImages:""},EHOES_API_KEY="XWUQOOGI1QGIHXQBY";return ArtistServices.fetchImages=function(artistName){$http.get("http://developer.echonest.com/api/v4/artist/images?api_key="+EHOES_API_KEY+"&name="+artistName+"&format=json&results=20&start=0&license=unknown").success(function(images){ArtistServices.artistImages=images.response.images})},ArtistServices.getImages=function(){return ArtistServices.artistImages},ArtistServices.getBio=function(artistName){$http.get(LastfmServices.baseUrl+"artist.getInfo&artist="+artistName+"&api_key="+LastfmServices.api+"&format=json").success(function(artistBio){$rootScope.$broadcast("artistBioReturned",artistBio)})},ArtistServices.getTopTracks=function(searchTerm){var d=$q.defer();return SearchServices.expandProgressBar(),PlayerServices.currentlyPlaying.title=searchTerm,PlayerServices.currentlyPlaying.albumName="Top tracks",PlayerServices.currentlyPlaying.releaseYear="all good :)",SearchServices.searchTerm=searchTerm,SearchServices.searchSource=SearchServices.searchSources.topTracks,$http.get(LastfmServices.baseUrl+"artist.gettoptracks&artist="+searchTerm+"&api_key="+LastfmServices.api+"&format=json&limit=20").success(function(topTracks){var playlist=LastfmServices.lastfmPlaylistToNodspot(searchTerm,topTracks,"artist");YoutubeServices.findVideos(playlist).then(function(playlistIds){d.resolve(playlistIds)})}),SearchServices.logSearch(searchTerm,"topTracks"),d.promise},ArtistServices.getSimilar=function(artistName){$http.get(LastfmServices.baseUrl+"artist.getSimilar&artist="+artistName+"&api_key="+LastfmServices.api+"&limit=15&format=json").success(function(similarArtists){$rootScope.$broadcast(EventsConstants.similarArtistsReturned,similarArtists)})},ArtistServices}]),nodspot.factory("LastfmServices",["$http","YoutubeServices","PlayerServices","SearchServices","$q",function($http,YoutubeServices,PlayerServices,SearchServices,$q){var LastfmServices={api:"364727cc40706da6eb7d5829f7435bd0",baseUrl:"http://ws.audioscrobbler.com/2.0/?method=",tagsTopTracks:[]};return LastfmServices.getTagsTopTracks=function(tagName){return SearchServices.expandProgressBar(),PlayerServices.currentlyPlaying.title=tagName,PlayerServices.currentlyPlaying.albumName="top tracks",PlayerServices.currentlyPlaying.releaseYear="all good",SearchServices.searchSource=SearchServices.searchSources.tag,SearchServices.searchTerm=tagName,$http.get(LastfmServices.baseUrl+"tag.gettoptracks&tag="+tagName+"&api_key="+LastfmServices.api+"&format=json")},LastfmServices.getTagsTopTracksVideos=function(tagName){var d=$q.defer();return LastfmServices.getTagsTopTracks(tagName).then(function(topTracks){YoutubeServices.findVideos(LastfmServices.lastfmPlaylistToNodspot(void 0,topTracks,"tag")).then(function(videos){d.resolve(videos)})}),SearchServices.logSearch(tagName,"tag"),PlayerServices.currentlyPlaying.albumName=tagName,PlayerServices.currentlyPlaying.title=tagName,PlayerServices.currentlyPlaying.releaseYear="Top tracks, all good :)",SearchServices.searchSource=SearchServices.searchSources.tag,d.promise},LastfmServices.lastfmPlaylistToNodspot=function(artistName,topTracks,type){var newPlaylist=[];switch(type){case"artist":angular.forEach(topTracks.toptracks.track,function(track,i){newPlaylist[i]={track_title:artistName+" "+track.name,artist_name:artistName}});break;case"tag":angular.forEach(topTracks.data.toptracks.track,function(track,i){newPlaylist[i]={track_title:track.artist.name+" "+track.name,artist_name:track.artist.name}})}return newPlaylist},LastfmServices}]),nodspot.factory("FacebookServices",["$http","$rootScope","ApiConstants",function($http,$rootScope,ApiConstants){var FacebookServices={};return FacebookServices.connected=!1,FacebookServices.isConnected=function(){return FacebookServices.connected},console.log("old cookie: "+document.cookie),FacebookServices.isSDKLoaded=function(){try{FacebookServices.subscribeToStatusChange()}catch(e){setTimeout(function(){FacebookServices.isSDKLoaded()},250)}},FacebookServices.subscribeToStatusChange=function(){FB.Event.subscribe("auth.statusChange",function(response){"connected"==response.status&&(FacebookServices.connected=!0)})},FacebookServices.login=function(callback){FB.login(function(response){$rootScope.$apply(function(){response.authResponse&&(FacebookServices.connected=!0,"function"==typeof callback&&callback(!0))})},{scope:"email, user_likes"})},FacebookServices.getUserInfo=function(callback){FB.api("/me",function(res){FacebookServices.userInfo={firstName:res.first_name,userId:res.id,userEmail:res.email},FacebookServices.getNodspotUserId(FacebookServices.userInfo.userId,FacebookServices.userInfo.userEmail),"function"==typeof callback&&callback(FacebookServices.userInfo)})},FacebookServices.isCookieSet=function(){return document.cookie.indexOf("hash")>-1},FacebookServices.getNodspotUserId=function(fbUserId,fbEmail){var eventCookieSet="requestCookieSet";$http.get(ApiConstants.baseUrlNodspot+"user/"+fbUserId+"/"+fbEmail+"/existing").then(function(res){console.log("new cookie: "+document.cookie),document.cookie="hash="+res.data+"; expires=Thu, 18 Dec 2020 12:00:00 UTC",$rootScope.$broadcast(eventCookieSet)})},FacebookServices.logout=function(){FB.logout(function(){$rootScope.$apply(function(){FacebookServices.connected=!1})})},FacebookServices.getLoginStatus=function(){void 0!=window.FB&&FB.getLoginStatus(function(res){$rootScope.$apply(function(){return FacebookServices.connected="connected"===res.status?!0:!1})})},FacebookServices}]),nodspot.factory("GenresServices",[function(){var GenresServices={};return GenresServices.stylesVisibility=!0,GenresServices.imagesPath="images/tag images/",GenresServices.randomAccent=function(){return Math.floor(8*Math.random())},GenresServices.setAccent=function(){angular.forEach(GenresServices.styles,function(style){style.accent=GenresServices.randomAccent()})},GenresServices.styles=[{name:"downtempo"},{name:"dubstep"},{name:"deep-house"},{name:"trance"},{name:"techno"},{name:"hardcore"},{name:"drum-n-bass"},{name:"jungle"},{name:"euro-dance"},{name:"tech-house"},{name:"electro"},{name:"rock & roll"},{name:"soul"},{name:"jazz"},{name:"hip-hop"},{name:"pop-rock"},{name:"synth-pop"},{name:"disco"},{name:"rap"},{name:"funk"},{name:"new-wave"},{name:"trip-hop"},{name:"broken-beat"},{name:"uk-garage"},{name:"idm"},{name:"dub-techno"},{name:"ambient"},{name:"dub"},{name:"gabber"},{name:"leftfield"},{name:"minimal"},{name:"hardstyle"},{name:"grime"},{name:"breakcore"},{name:"reggae"},{name:"bossanova"},{name:"swing"}],GenresServices.setAccent(),GenresServices.tags=[{name:"lounge",src:GenresServices.imagesPath+"lounge1.jpg",source:"http://www.trendir.com/interiors/contemporary-living-room-design-ideas-inspiration-in-bright-contrast-colors.html"},{name:"autumn",src:GenresServices.imagesPath+"autumn2.jpg",source:"http://web.stagram.com/p/301329562910091684_2906305"},{name:"summer",src:GenresServices.imagesPath+"summer2.jpg",source:"http://dreamdoterra.hubpages.com/hub/Alternative-Antidepressant-Natural-Safer-and-No-Side-Effects"},{name:"winter",src:GenresServices.imagesPath+"winter2.jpg",source:"http://websta.me/p/626075998912539155_2906305#jaQUlKDLCx7WJJtV.32"},{name:"ibiza",src:GenresServices.imagesPath+"ibiza2.jpg",source:"http://www.buzzfeed.com/perpetua/totally-chill-songs-for-the-summer?s=mobile"},{name:"walking",src:GenresServices.imagesPath+"walking2.jpg",source:"https://www.guarantorloansonline.co.uk/Blog/15-Ways-To-Save-Money"},{name:"night",src:GenresServices.imagesPath+"night1.jpg",source:"http://www.flickr.com/photos/kailashnadh/5921656351/"},{name:"confusion",src:GenresServices.imagesPath+"confusion2.jpg",source:"http://www.pinterest.com/jasonmpeterson/"},{name:"night driving",src:GenresServices.imagesPath+"night-driving1.jpg",source:"http://limeflavored.tumblr.com/post/52771398276"},{name:"sunday morning",src:GenresServices.imagesPath+"sunday-morning2.jpg",source:"http://theaccidentalexecutive.tumblr.com/post/50821316276"},{name:"city",src:GenresServices.imagesPath+"city2.jpg",source:"http://web.stagram.com/p/466484148783314198_3281308#J06bKlbyBSGOxSKt.32"},{name:"new york",src:GenresServices.imagesPath+"new-york1.jpg",source:"http://estilo-tendances.com/sunday-photo-york-city/?crlt.pid=camp.bPKN8vt7AKsk"},{name:"london",src:GenresServices.imagesPath+"london2.jpg",source:"http://media-cache-ec0.pinimg.com/736x/04/8d/c0/048dc0d9cc86d33b2f9ab251433b4d5c.jpg"},{name:"paris",src:GenresServices.imagesPath+"paris1.jpg",source:"http://www.pinterest.com/jhelkim/"},{name:"romantic",src:GenresServices.imagesPath+"romantic2.jpg",source:"http://www.pinterest.com/pin/360921357609600838/"},{name:"happy",src:GenresServices.imagesPath+"happy3.jpg",source:"http://favimages.com/image/164901/"},{name:"sad",src:GenresServices.imagesPath+"sad2.jpg",source:"http://2ndbook.tumblr.com/post/22707280772"},{name:"lonely",src:GenresServices.imagesPath+"lonely2.jpg",source:"http://weheartit.com/entry/49356465/via/l0vefashion"},{name:"erotic lounge",src:GenresServices.imagesPath+"erotic-lounge2.jpg",source:"http://krane-inner-sanctum.tumblr.com/page/5"},{name:"soothing",src:GenresServices.imagesPath+"soothing2.jpg",source:"http://weheartit.com/entry/5087416/via/melinwonderland"},{name:"on the road",src:GenresServices.imagesPath+"on-the-road2.jpg",source:"http://www.brightboldbeautiful.com/2013/07/13/weekend-roundup-18/"},{name:"spacious",src:GenresServices.imagesPath+"spacious1.jpg",source:"http://www.bt-images.net/incredible-universe/"},{name:"rain",src:GenresServices.imagesPath+"rain1.jpg",source:"http://www.pinterest.com/averybeaudrot/"},{name:"sunset",src:GenresServices.imagesPath+"sunset2.jpg",source:"http://www.pinterest.com/pin/396316835931866089/"},{name:"chill",src:GenresServices.imagesPath+"chill2.jpg",source:"http://www.pinterest.com/60sthrowback/"},{name:"atmospheric",src:GenresServices.imagesPath+"atmospheric1.jpg",source:"http://www.pinterest.com/pin/540924605216978036/"},{name:"acoustic",src:GenresServices.imagesPath+"acoustic1.jpg",source:"http://www.pinterest.com/pin/394698354813685100/"},{name:"sunny",src:GenresServices.imagesPath+"sunny1.jpg",source:"http://girls-4-god.blogspot.com/2012/08/faith-friday-10-encouraging-bible.html"},{name:"ambient",src:GenresServices.imagesPath+"ambient1.jpg",source:"http://commons.wikimedia.org/wiki/File:Mellieha-red_skies.jpg"},{name:"80s",src:GenresServices.imagesPath+"80s2.jpg",source:"http://www.pinterest.com/pin/304344887290563996/"}],GenresServices.getTags=function(){return GenresServices.tags},GenresServices.getStyles=function(){return GenresServices.styles},GenresServices.isVisible=function(){return GenresServices.stylesVisibility},GenresServices}]),nodspot.factory("SearchServices",["$http","ApiConstants",function($http,ApiConstants){var baseUrl=ApiConstants.baseUrlNodspot,SearchServices={searchTerm:"",searchType:"",searchAttempt:0,searchSources:{hash:0,userInput:1,surpriseMe:2,userPlaylist:3,directYoutube:4,topTracks:5,tag:6,youtubePlaylist:7},searchSource:0,hash:{releaseId:"",startFrom:0},surprise:{releaseId:void 0,style:void 0,page:void 0},progressBarVisibility:!1,collapseProgressBar:function(){SearchServices.progressBarVisibility=!1},expandProgressBar:function(){SearchServices.progressBarVisibility=!0},getProgressBarVisibility:function(){return SearchServices.progressBarVisibility}};return SearchServices.getSearchSource=function(){return SearchServices.searchSource},SearchServices.logSearch=function(searchTerm,searchType){$http.get(baseUrl+"log/"+searchTerm+"/"+searchType)},SearchServices}]),nodspot.factory("HelperServices",["$http","EventsConstants","$q",function(){var HelperServices={playlistPosition:void 0,extractVideoIds:function(videos){var playlistIds=[];return angular.forEach(videos,function(video){playlistIds.push(video.id.videoId)}),playlistIds},getTracklistsAbsolutePosition:function(){return void 0==HelperServices.playlistPosition?HelperServices.playlistPosition=document.querySelector("#ytTrackList").getBoundingClientRect():HelperServices.playlistPosition}};return HelperServices}]),nodspot.factory("SpotifyServices",["$http","$q",function(){var spotifyApi=new SpotifyWebApi;console.log(spotifyApi);var SpotifyServices={clientId:"d965e43a5858459c8e4f18cd9ced6c4d",findAlbums:function(searchTerm){return spotifyApi.searchAlbums(searchTerm)},getAlbumTracks:function(albumId){return spotifyApi.getAlbumTracks(albumId)}};return SpotifyServices}]),nodspot.directive("addToPlaylist",function(){return{restrict:"E",templateUrl:"views/partials/addToPlaylist.html"}}),nodspot.directive("releaseItem",function(){return{restrict:"E",templateUrl:"views/partials/releaseItem.html",scope:{releases:"=",playRelease:"=",searchFavourites:"="}}}),nodspot.directive("playlistItemOptions",[function(){return{restrict:"E",templateUrl:"views/partials/playlistItemOptions.html",scope:{source:"=",playlistEditMode:"=",deletePlaylist:"=",$index:"=index",playlist:"=",renamePlaylist:"="}}}]),nodspot.directive("suggestions",[function(){return{restrict:"E",template:"<ul class='dropdown' ng-transclude></ul>",transclude:!0,link:function(scope,element){element.on("mouseleave click",function(){scope.collapse()}),scope.collapse=function(){scope.suggestionsVisibility=!1,scope.$apply()},scope.expand=function(){scope.suggestionsVisibility=!0,scope.$apply()}},scope:{suggestionsVisibility:"=",suggestions:"="}}}]),nodspot.directive("lookup",[function(){return{restrict:"A",link:function(scope,element){element.bind("keydown",function(event){try{38===event.which?scope.getSelectionIndex("up"):40===event.which&&scope.getSelectionIndex("down")}catch(e){}}),scope.getSelectionIndex=function(direction){"down"==direction?scope.$parent.highlightedSuggestion++:"up"==direction&&scope.$parent.highlightedSuggestion--,scope.$parent.highlightedSuggestion>scope.$parent.suggestions.length-1?scope.$parent.highlightedSuggestion=0:scope.$parent.highlightedSuggestion<=-1&&(scope.$parent.highlightedSuggestion=scope.$parent.suggestions.length-1),scope.highlightItem(scope.$parent.highlightedSuggestion)},scope.highlightItem=function(index){scope.$apply(function(){angular.forEach(scope.$parent.suggestions,function(suggestion){suggestion.state=""}),scope.$parent.suggestions[index].state="active",scope.$parent.searchTerm=scope.$parent.suggestions[index].searchTerm})}},scope:{highlightedSuggestion:"="}}}]),nodspot.directive("thumbnail",["HelperServices","$timeout",function(HelperServices,$timeout){return{restrict:"A",link:function(scope,element){element.bind("mouseenter",function(event){var el=element[0].children[2];scope.$parent.track.thumbVisiblity=!0,el.style.top=event.clientY-30+"px",el.style.left=HelperServices.getTracklistsAbsolutePosition().left-130+"px",$timeout(function(){scope.$parent.track.thumbVisiblity=!1},1300)}),element.bind("mouseleave",function(){scope.$parent.track.thumbVisiblity=!1})},scope:{}}}]),nodspot.directive("dock",["PlayerServices","$interval",function(PlayerServices,$interval){return{restrict:"A",link:function(scope,element,attrs){{var y=attrs.y,x=attrs.x,dy=attrs.dy,dx=attrs.dx,z=attrs.z,w1=attrs.w1,w2=attrs.w2,h1=attrs.h1,h2=attrs.h2,colour=attrs.colour,treshold=attrs.treshold;$interval(function(){if(PlayerServices.scrollY>=treshold){switch(y){case"bottom":element.css({bottom:dy});break;case"top":element.css({top:dy})}switch(x){case"left":element.css({left:dx});break;case"right":element.css({right:dx})}element.css({position:"fixed",width:w2,height:h2,"z-index":z,color:colour})}else element.css({position:"static",width:w1,height:h1,color:"inherit"})},500)}}}}]),nodspot.controller("FavouritesCtrl",["$rootScope","$scope","FavouritesServices","YoutubeServices","ReleasesServices","PlayerServices","ArtistServices","SearchServices","FacebookServices","EventsConstants",function($rootScope,$scope,FavouritesServices,YoutubeServices,ReleasesServices,PlayerServices,ArtistServices,SearchServices,FacebookServices){$scope.placeholderVisibility=!0,$scope.favouritesPanelVisibility=!1,$scope.releases=[],$scope.playlists=[],$scope.predicate="-artist_name",$scope.hidePlaceholder=function(){$scope.placeholderVisibility=!1},$scope.expandPanel=function(){$scope.state="expanded"},$scope.collapsePanel=function(){$scope.state="collapsed"},$scope.$watch(FacebookServices.isConnected,function(){FacebookServices.isConnected()&&($scope.favouritesPanelVisibility=!0)}),$scope.$on("requestCookieSet",function(){FavouritesServices.fetchPlaylists(),FavouritesServices.fetchFavourites()}),$scope.$watch(FavouritesServices.getPlaylists,function(){$scope.playlists=FavouritesServices.getPlaylists(),$scope.hidePlaceholder()}),$scope.$watch(FavouritesServices.getFavourites,function(){$scope.releases=FavouritesServices.getFavourites(),$scope.releases=ReleasesServices.generateThumbnails("artist_name",$scope.releases),$scope.hidePlaceholder()}),$scope.getPlaylistTracks=function(index,playlistId){var playlist=$scope.playlists[index];$scope.playlists[index].is_youtube?YoutubeServices.getVideosFromYoutubePlaylist(playlist.youtube_playlist_id).then(function(videos){PlayerServices.loadPlaylist(videos,0),PlayerServices.currentlyPlaying.albumName=videos.length+" tracks",PlayerServices.currentlyPlaying.playlistId=playlist.youtube_playlist_id,SearchServices.searchSource=SearchServices.searchSources.youtubePlaylist}):FavouritesServices.getPlaylistTracks(playlistId).then(function(videos){PlayerServices.loadPlaylist(videos,0),PlayerServices.currentlyPlaying.albumName=playlist.playlist_name+", "+videos.length+" tracks",PlayerServices.currentlyPlaying.playlistId=playlistId,SearchServices.searchSource=SearchServices.searchSources.userPlaylist}),PlayerServices.currentlyPlaying.releaseYear="all good :)"},$scope.playlistEditMode=function(index,event){FavouritesServices.playlistEditMode(index,event)},$scope.deletePlaylist=function(index,playlistId,event){FavouritesServices.deletePlaylist(index,playlistId,event)},$scope.renamePlaylist=function(index,playlistId,newPlaylistName,event){FavouritesServices.renamePlaylist(index,playlistId,newPlaylistName,event)}}]),nodspot.controller("AddToPlaylistCtrl",["$scope","FavouritesServices",function($scope,FavouritesServices){$scope.playlistName="",$scope.myFirstPlaylistVisibility=!0,$scope.$watch(FavouritesServices.getPlaylists,function(){$scope.playlists=FavouritesServices.playlists,$scope.myFirstPlaylistVisibility=$scope.playlists.length>0?!1:!0}),$scope.$watch(FavouritesServices.getTracksPlaylists,function(){$scope.tracksPlaylists=FavouritesServices.tracksPlaylists,FavouritesServices.highlightTracksPlaylists($scope.playlists,$scope.tracksPlaylists)}),$scope.playlistEditMode=function(index,event){FavouritesServices.playlistEditMode(index,event)},$scope.addTrackToPlaylist=function(index,trackState,playlistId,event){"input"!=event.target.localName&&("notSaved"==trackState&&""!=playlistId?FavouritesServices.addTrackToPlaylist(FavouritesServices.trackId,playlistId,null,FavouritesServices.trackTitle,FavouritesServices.artistName).success(function(){$scope.playlists[index].state="saved"}):"saved"==trackState&&(FavouritesServices.removeTrackFromPlaylist(FavouritesServices.trackId,playlistId),$scope.playlists[index].state="notSaved"))},$scope.renamePlaylist=function(index,playlistId,newPlaylistName,event){FavouritesServices.renamePlaylist(index,playlistId,newPlaylistName,event)},$scope.deletePlaylist=function(index,playlistId,event){FavouritesServices.deletePlaylist(index,playlistId,event)},$scope.addTrackToNewPlaylist=function(playlistName,event){(13==event.which||1==event.which)&&FavouritesServices.createPlaylist(playlistName).success(function(playlistId){FavouritesServices.addTrackToPlaylist(FavouritesServices.trackId,playlistId,playlistName,FavouritesServices.trackTitle,FavouritesServices.artistName).success(function(){FavouritesServices.fetchPlaylists()})})}}]),nodspot.controller("PlayerCtrl",["$scope","$window","$rootScope","ReleasesServices","PlayerServices","FavouritesServices","EventsConstants","GenresServices","ArtistServices","SearchServices","LastfmServices","YoutubeServices",function($scope,$window,$rootScope,ReleasesServices,PlayerServices,FavouritesServices,EventsConstants,GenresServices,ArtistServices,SearchServices,LastfmServices,YoutubeServices){var myWindow=angular.element($window);$scope.playerVisibility=!1,$scope.favouriteBtnVisibility=!1,$scope.playerClass="",$scope.playlist=[],$scope.currentlyPlaying={state:"unfavourited"},$scope.collapseFavouriteBtn=function(){$scope.favouriteBtnVisibility=!1
},$scope.expandFavouriteBtn=function(){$scope.favouriteBtnVisibility=!0},$scope.downloadVideo=function($videoId,event){event.stopPropagation(),window.location.target="_blank",window.open("http://convert2mp3.net/c-mp4.php?url=http://convert2mp3.net/share.php?url=https://www.youtube.com/watch?v="+$videoId,"_blank")},$scope.playTopTracks=function(artistName,event){event.stopPropagation(),ArtistServices.getTopTracks(artistName).then(function(playlistIds){PlayerServices.loadPlaylist(playlistIds,0)})},$scope.playTagsTopTracks=function(tagName){LastfmServices.getTagsTopTracksVideos(tagName).then(function(videos){PlayerServices.loadPlaylist(videos,0)})},$scope.isValidVideo=function(currentTrackIndex){var videoId=$scope.playlist[currentTrackIndex].id.videoId;SearchServices.searchSource==SearchServices.searchSources.userPlaylist&&YoutubeServices.isValidVideo(videoId).then(function(isValid){isValid||(FavouritesServices.removeTrackFromPlaylist(videoId,$scope.currentlyPlaying.playlistId),$scope.playlist.splice(currentTrackIndex,1),PlayerServices.currentlyPlaying.track++,PlayerServices.loadPlaylist(YoutubeServices.returnedVideos,PlayerServices.currentlyPlaying.track),PlayerServices.updateHash())})},$scope.highlightTrack=function(index){$scope.playlist&&(angular.forEach($scope.playlist,function(track){track.state=void 0}),$scope.playlist[index].state="active")},$scope.playTrack=function(index){PlayerServices.playTrack(index)},$scope.captureTrackInfo=function(index,event){event.stopPropagation(),FavouritesServices.captureTrackInfo(index)},$scope.addReleaseToFavourites=function(releaseTitle,artistName,releaseId,releaseYear,releaseType){"unfavourited"==$scope.currentlyPlaying.state?FavouritesServices.addReleaseToFavourites(releaseTitle,artistName,releaseId,releaseYear,releaseType,SearchServices.searchTerm).then(function(){$scope.isReleaseFavourite(releaseId)}):$scope.removeReleaseFromFavourites(releaseId)},$scope.removeReleaseFromFavourites=function(releaseId){FavouritesServices.removeReleaseFromFavourites(releaseId).then(function(){$scope.isReleaseFavourite(releaseId)})},$scope.share=function(){var imgUrl="",nodspotLogo="http://nodspot.com/images/logo75x75.png",caption="";switch(imgUrl=ArtistServices.artistImages.length>0?ArtistServices.artistImages[0].url:nodspotLogo,SearchServices.searchSource){case SearchServices.searchSources.surpriseMe:case SearchServices.searchSources.userInput:default:caption="Listen to "+PlayerServices.currentlyPlaying.title+" album "+PlayerServices.currentlyPlaying.albumName+" containing "+$scope.playlist.length+" tracks at nodspot.com.";break;case SearchServices.searchSources.directYoutube:caption=PlayerServices.currentlyPlaying.title+" all tracks from youtube here at nodspot.com!",imgUrl=nodspotLogo;break;case SearchServices.searchSources.topTracks:caption="Listen to top tracks from "+PlayerServices.currentlyPlaying.title+" at nodspot.com!",imgUrl=nodspotLogo;break;case SearchServices.searchSources.tag:imgUrl="http://www.nodspot.com/"+GenresServices.imagesPath+PlayerServices.currentlyPlaying.title.replace(/ /g,"-")+"1.jpg",caption="Listen to "+PlayerServices.currentlyPlaying.title+" playlist, containing "+$scope.playlist.length+" tracks at nodspot.com."}FB.ui({method:"feed",name:$scope.playlist[$scope.currentlyPlaying.track].snippet.title,caption:caption,link:location.href,picture:imgUrl,type:"video"},function(){})},$scope.isReleaseFavourite=function(releaseId){releaseId&&FavouritesServices.isReleaseFavourite(releaseId).success(function(state){state.length>0?($scope.currentlyPlaying.state="favourited",$scope.currentlyPlaying.favouriteBtnTitle="Unfavourite release"):($scope.currentlyPlaying.state="unfavourited",$scope.currentlyPlaying.favouriteBtnTitle="Favourite release")})},$scope.$watchCollection(PlayerServices.getCurrentlyPlaying,function(newCurrentlyPlaying,oldCurrentlyPlaying){try{var currentTrackIndex=PlayerServices.currentlyPlaying.track;try{$scope.highlightTrack(currentTrackIndex)}catch(e){}newCurrentlyPlaying.artistName!=oldCurrentlyPlaying.artistName&&(PlayerServices.currentlyPlaying.artistName=$scope.playlist[currentTrackIndex].artistName,ReleasesServices.findAlbums($scope.playlist[currentTrackIndex].artistName),ArtistServices.getSimilar($scope.playlist[currentTrackIndex].artistName)),$scope.isValidVideo(currentTrackIndex)}catch(e){}}),$scope.$on(EventsConstants.trackChanged,function(){var currentTrackIndex=PlayerServices.currentlyPlaying.track;$scope.highlightTrack(currentTrackIndex),$scope.currentlyPlaying=PlayerServices.currentlyPlaying,$scope.currentlyPlaying.title=$scope.playlist[currentTrackIndex].snippet.title,$scope.currentlyPlaying.artistName=$scope.playlist[currentTrackIndex].artistName}),$scope.$on(EventsConstants.releaseFavourited,function(){$scope.currentlyPlaying.state="favourited"}),$scope.$watch(SearchServices.getSearchSource,function(){var searchSource=SearchServices.getSearchSource();searchSource==SearchServices.searchSources.tag||searchSource==SearchServices.searchSources.topTracks||searchSource==SearchServices.searchSources.directYoutube||searchSource==SearchServices.searchSources.userPlaylist?$scope.collapseFavouriteBtn():$scope.expandFavouriteBtn(),$scope.topTracksBtnVisibility=searchSource==SearchServices.searchSources.directYoutube?!1:!0}),$scope.$watch(PlayerServices.getPlayerVisibility,function(){$scope.playerVisibility=PlayerServices.getPlayerVisibility()}),$scope.$watchCollection(YoutubeServices.getReturnedVideos,function(){$scope.playlist=PlayerServices.removeEmptyItemsFromArray(YoutubeServices.getReturnedVideos()),SearchServices.collapseProgressBar()}),myWindow.on("keypress",function(e){"input"!=e.target.localName&&(120==e.which?ytPlayer.nextVideo():122==e.which?ytPlayer.previousVideo():97==e.which&&ytPlayer.seekTo(ytPlayer.getCurrentTime()+40))}),myWindow.on("scroll",function(){PlayerServices.scrollY=$window.scrollY})}]),nodspot.controller("ReleasesCtrl",["$scope","ReleasesServices","EventsConstants","SearchServices","PlayerServices",function($scope,ReleasesServices,EventsConstants,SearchServices,PlayerServices){$scope.sidebarVisibility=!1,$scope.releasesVisibility=!0,$scope.releases=void 0,$scope.searchType=void 0,$scope.releaseId=void 0,$scope.collapseReleases=function(){$scope.releasesVisibility=!1},$scope.expandReleases=function(){$scope.releasesVisibility=!0},$scope.collapseSidebar=function(){$scope.sidebarVisibility=!1},$scope.expandSidebar=function(){$scope.sidebarVisibility=!0},$scope.playRelease=function(albumId,searchTerm,index){ReleasesServices.getAlbumTracklist(albumId).then(function(tracklist){ReleasesServices.findVideos(tracklist).then(function(videos){PlayerServices.loadPlaylist(videos,0)}),SearchServices.searchSource=SearchServices.searchSources.userInput,PlayerServices.currentlyPlaying.albumId=albumId,PlayerServices.currentlyPlaying.albumName=ReleasesServices.returnedReleases[index].name,ReleasesServices.highlightRelease(albumId)})},$scope.$on(EventsConstants.similarArtistsReturned,function(){$scope.expandSidebar()}),$scope.$watchCollection(ReleasesServices.getReleases,function(){$scope.releases=ReleasesServices.getReleases(),$scope.releases.length>0?($scope.expandReleases(),$scope.releases.searchTerm=PlayerServices.currentlyPlaying.artistName):$scope.collapseReleases()})}]),nodspot.controller("SearchCtrl",["$scope","ReleasesServices","ArtistServices","GenresServices","SearchServices","PlayerServices","LastfmServices","$window","$http","SpotifyServices",function($scope,ReleasesServices,ArtistServices,GenresServices,SearchServices,PlayerServices,LastfmServices){$scope.surpriseMeVisibility=!1,$scope.suggestionsVisibility=!1,$scope.tagBtnVisibility=!0,$scope.stylesDropdownVisibility=!1,$scope.searchTerm="",$scope.styles=GenresServices.getStyles(),$scope.searchInputClass="",$scope.suggestions=[],$scope.highlightedSuggestion=-1,$scope.handleKeypress=function(searchTerm,searchType,event){$scope.searchSubmitted=!1,13===event.which&&""!=searchTerm?($scope.search(searchTerm,searchType,event),$scope.searchSubmitted=!0):searchTerm.length>1&&ReleasesServices.getSuggestions(searchTerm).success(function(suggestions){$scope.suggestions=suggestions[1],angular.forEach($scope.suggestions,function(suggestion,i){$scope.suggestions[i]={searchTerm:suggestion,state:void 0}});try{$scope.suggestions.length>0&&0==$scope.searchSubmitted&&$scope.expandSuggestions()}catch(e){}})},$scope.getSearchTerm=function(){return $scope.searchTerm},$scope.$watch($scope.getSearchTerm,function(){$scope.processSearchTerm()}),$scope.processSearchTerm=function(){$scope.searchTerm.split(" ").length;$scope.suggestionButtonsVisibility=""==$scope.searchTerm?!1:!0},$scope.playTagsTopTracks=function(tagName){LastfmServices.getTagsTopTracksVideos(tagName).then(function(videos){PlayerServices.loadPlaylist(videos,0)}),$scope.searchSubmitted=!0},$scope.playTopTracks=function(searchTerm){ArtistServices.getTopTracks(searchTerm).then(function(videos){PlayerServices.loadPlaylist(videos,0)}),$scope.searchSubmitted=!0},$scope.getVideosFromYoutube=function(searchTerm){ReleasesServices.getVideosFromYoutube(searchTerm,40).then(function(videos){PlayerServices.loadPlaylist(videos,0)}),SearchServices.logSearch(searchTerm,"youtube"),$scope.searchSubmitted=!0},$scope.search=function(searchTerm){$scope.searchSubmitted=!0,$scope.collapseSuggestions(),SearchServices.searchSource=SearchServices.searchSources.userInput,ReleasesServices.getVideosFromYoutube(searchTerm,40).then(function(videos){PlayerServices.loadPlaylist(videos,0)}),ReleasesServices.findAlbums(searchTerm),SearchServices.logSearch(searchTerm,"search"),PlayerServices.resetCurrentlyPlaying()},$scope.expandSuggestions=function(){$scope.suggestionsVisibility=$scope.suggestions.length>0?!0:!1},$scope.collapseSuggestions=function(){$scope.suggestionsVisibility=!1},$scope.toggleStylesDropdown=function(){0==$scope.stylesDropdownVisibility?$scope.stylesDropdownVisibility=!0:$scope.collapseSurpriseDropdown()},$scope.collapseSurpriseDropdown=function(){$scope.stylesDropdownVisibility=!1},$scope.getReleasesByStyle=function(style){$scope.collapseSurpriseDropdown(),ReleasesServices.getReleasesByStyle(style)},$scope.$watch(GenresServices.isVisible,function(){1==GenresServices.isVisible()?($scope.surpriseMeVisibility=!1,$scope.searchInputClass="docked"):($scope.surpriseMeVisibility=!0,$scope.searchInputClass="")})}]),nodspot.controller("ArtistsCtrl",["$scope","ReleasesServices","EventsConstants","ArtistServices","SearchServices","PlayerServices",function($scope,ReleasesServices,EventsConstants,ArtistServices,SearchServices,PlayerServices){$scope.artistImagesVisibility=!1,$scope.expandPanel=function(){$scope.state="expanded"},$scope.collapsePanel=function(){$scope.state="collapsed"},$scope.$on(EventsConstants.similarArtistsReturned,function(event,response){try{$scope.similarArtists=response.similarartists.artist,$scope.similarArtists=ReleasesServices.generateThumbnails("name",$scope.similarArtists)}catch(e){}}),$scope.$on(EventsConstants.artistBioReturned,function(event,response){$scope.artist=response.artist}),$scope.$watch(ArtistServices.getImages,function(){$scope.images=ArtistServices.getImages(),$scope.artistImagesVisibility=$scope.images.length>0?!0:!1}),$scope.searchArtist=function(artistName){SearchServices.logSearch(artistName,"similar"),PlayerServices.resetCurrentlyPlaying(),SearchServices.searchSource=SearchServices.searchSources.userInput,ReleasesServices.getVideosFromYoutube(artistName,40).then(function(videos){PlayerServices.loadPlaylist(videos,0)}),ReleasesServices.findAlbums(artistName)}}]),nodspot.controller("GenresCtrl",["$scope","ReleasesServices","EventsConstants","GenresServices","LastfmServices","$rootScope","PlayerServices",function($scope,ReleasesServices,EventsConstants,GenresServices,LastfmServices,$rootScope,PlayerServices){$scope.visibility=!0,$scope.styles=GenresServices.getStyles(),$scope.$watch(GenresServices.getStyles,function(){$scope.styles=GenresServices.getStyles()}),$scope.$watch(GenresServices.getTags,function(){$scope.tags=GenresServices.getTags()}),$scope.playTagsTopTracks=function(tagName){LastfmServices.getTagsTopTracksVideos(tagName).then(function(videos){PlayerServices.loadPlaylist(videos,0)}),$scope.collapseTagsAndGenres()},$scope.collapseTagsAndGenres=function(){$scope.visibility=!1,$rootScope.$broadcast(EventsConstants.showPlayer)},$scope.setAccent=function(){GenresServices.setAccent()},$scope.$watch(GenresServices.isVisible,function(){$scope.visibility=GenresServices.isVisible()}),$scope.getReleasesByStyle=function(style){ReleasesServices.getReleasesByStyle(style),$scope.collapseTagsAndGenres()}}]),nodspot.controller("OverlayCtrl",["$scope","EventsConstants",function($scope,EventsConstants){$scope.overlayVisibility=!1,$scope.closeOverlay=function(event){("overlay"==event.target.id||"btn btnDark close"==event.target.className)&&($scope.overlayVisibility=!1)},$scope.$on(EventsConstants.trackInfoCaptured,function(){$scope.overlayVisibility=!0})}]),nodspot.controller("LoginCtrl",["$scope","FacebookServices","LoginConstants","FavouritesServices","GenresServices","EventsConstants","$rootScope","YoutubeServices",function($scope,FacebookServices,LoginConstants,FavouritesServices,GenresServices,EventsConstants,$rootScope,YoutubeServices){$scope.loginMenuClass="collapsed",$scope.$watch(FacebookServices.isConnected,function(){FacebookServices.isConnected()?($scope.facebookBtn=LoginConstants.fbLogout,FacebookServices.getUserInfo(function(userInfo){$scope.$apply(function(){$scope.user=userInfo})})):$scope.facebookBtn=LoginConstants.fbLogin}),$scope.expandGenres=function(){window.location.href="http://www.nodspot.com"},$scope.toggleVisibility=function(){$scope.loginMenuClass="collapsed"==$scope.loginMenuClass?"":"collapsed"},$scope.fbLogin=function(){FacebookServices.isConnected()?FacebookServices.logout():FacebookServices.login(),$scope.loginMenuVisibility=!1},$scope.ytLogin=function(){YoutubeServices.auth(),YoutubeServices.getUsersYoutubePlaylists().then(function(playlists){FavouritesServices.createPlaylistTypeYoutube(playlists.data.items[0].snippet.title,playlists.data.items[0].id).then(function(){FavouritesServices.fetchPlaylists()})})}}]),nodspot.controller("TipsCtrl",["$scope","FavouritesServices","PlayerServices",function($scope,FavouritesServices,PlayerServices){$scope.tipVisibility=!0,$scope.addTrackToPlaylist=function(){var index=PlayerServices.currentlyPlaying.track;FavouritesServices.captureTrackInfo(index)},$scope.collapseTip=function(){$scope.tipVisibility=!1,localStorage.showTips=0},$scope.$watch(PlayerServices.getFirstTimePlay,function(){$scope.tipVisibility=PlayerServices.getFirstTimePlay()})}]);